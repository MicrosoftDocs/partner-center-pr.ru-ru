...
Быстро растущий спрос на облачные решения и службы открывает партнерам корпорации Майкрософт любых размеров многочисленные возможности для построения прибыльных компаний по разработке облачных решений. Партнеры, готовые к вводу рынка, но не желающие управлять несколькими поставщиками или не имеющие комплексной инфраструктуры управления взаимоотношениями с клиентами, могут зарегистрироваться в программе поставщика облачных решений Майкрософт (CSP) как косвенную торговые посредники.
...
> [!NOTE]  
> Если вы уже зарегистрировались в CSP, для создания учетной записи торгового посредника в центре партнеров может потребоваться предоставить только контактные данные службы поддержки клиентов. 

### <a name="before-you-begin"></a>Перед началом работы

Если вы не знакомы с CSP, вам потребуется зарегистрироваться в программе в качестве непрямого торгового посредника и создать учетную запись в центре партнеров. Для этого необходимо указать следующие сведения в процессе регистрации. Рекомендуется потратить несколько минут, чтобы собрать эти сведения, прежде чем начать:

-   **Учетные данные глобального администратора для вашей рабочей учетной записи**<br>
Вам необходимо указать имя пользователя и пароль, применяемые для входа в Office 365, Microsoft Azure или Microsoft Dynamics CRM. Если у вас нет рабочей учетной записи, вы можете создать ее во время регистрации. Если вы не уверены, есть ли у вас Рабочая учетная запись, см. статью [рабочие учетные записи и центр партнеров](azure-active-directory-tenants-and-partner-center.md).


-   **Имя пользователя и пароль, используемые для входа на сайт центра членства партнера**<br>
Мы используем эти сведения, чтобы связать идентификатор Microsoft Partner Network вашей организации (идентификатор MPN) с новой учетной записью центра партнеров, чтобы вы могли управлять преимуществами членства и данными в центре партнеров.

-   **Юридическое название организации, адрес, основное контактное лицо и сведения о поддержке.**<br>
...
4.  Просмотрите сведения о том, как сопоставить идентификатор Microsoft Partner Network (идентификатор MPN) со своей новой учетной записью Центра партнеров. Нам нужно связать идентификатор MPN вашей организации с новой учетной записью центра партнеров, чтобы вы могли управлять преимуществами членства и поощрениями в центре партнеров. Выберите **Войти**.
...
> [!IMPORTANT]  
> Выберите идентификатор MPN, связанный с активным профилем организации, расположенным в той же стране или регионе, что и ваш клиент Azure AD.
...
1\.  В **центре партнеров**щелкните значок **Параметры** , а затем выберите **Управление пользователями**.  

2\.  Выберите свое имя в списке пользователей, а затем выберите **Агент администрирования**, если он еще не выбран. Выберите **Обновить**.   
...
> 
> Пользователю необходимо будет войти в центр партнеров, указав имя пользователя и временный пароль. Когда пользователь впервые входит в центр партнеров, ему предлагается изменить пароль.        
...
Если вы еще не работаете с поставщиком (другое название — дистрибьютор), вы можете [найти поставщика в списке официальных поставщиков корпорации Майкрософт](https://partnercenter.microsoft.com/partner/find-a-provider). Найдя поставщика, с которым вы хотели бы сотрудничать, обратитесь к нему напрямую, чтобы обсудить его программы посредничества, уровень поддержки и условия. Если вам и поставщику требуется совместная работа, вам потребуется подключить учетные записи в центре партнеров. 

Если косвенный поставщик хочет подключиться к вам в центре партнеров, он будет запускать следующий рабочий процесс:

1.  Косвенный поставщик присылает вам по электронной почте приглашение, чтобы вы авторизовали его как своего косвенного поставщика. Сообщение электронной почты содержит ссылку на центр партнеров и свяжет вашу учетную запись с учетной записью поставщика.

2.  Чтобы принять приглашение, перейдите по ссылке в электронном письме поставщика. Возможно, потребуется снова войти в центр партнеров.
...
> [!NOTE]  
> При установлении партнерства с косвенным поставщиком вы предоставляете им разрешение на отправку заказов и добавление подписок от имени ваших клиентов, а также предоставление им доступа администратора к рабочей учетной записи организации. После установления партнерских отношений с поставщиком можно удалить права доступа администратора поставщика к вашей рабочей учетной записи на портале Office 365. 

4.  Выберите **косвенные поставщики** из меню **центра партнеров** , чтобы просмотреть список поставщиков, с которыми вы взаимодействуюте. 
...
> [!IMPORTANT]  
> Ваш косвенный поставщик должен иметь отношение торгового посредника с клиентами для отправки заказов от их имени. 
 
## <a name="connect-with-customers"></a>Связь с клиентами

Чтобы выполнить инструкцию Transact с клиентами в центре партнеров, клиенты должны иметь учетные записи центра партнеров, и вы должны установить связи между торговыми посредниками. Чтобы разрешить косвенному поставщику приобретать подписки и службы от имени ваших клиентов, поставщик должен также установить с ними отношения торгового посредника. 

### <a name="connect-with-existing-customers"></a>Связь с существующими клиентами

Клиенты, которые уже выполнили переход с помощью других порталов, например центра администрирования Office 365 Partner Center или портала Microsoft Azure администрирования, будут отображаться в списке клиентов в центре партнеров после успешной регистрации в качестве непрямого торгового посредника. Выберите **Клиенты** в меню **центра партнеров** , чтобы просмотреть список клиентов. 

При взаимодействии с непрямым поставщиком вы не получаете клиентов непрямого поставщика автоматически. Аналогичным образом клиенты, работающие с вами самостоятельно или через непрямой поставщик, но не через центр партнеров, не будут автоматически отображаться в списке клиентов при регистрации в центре партнеров. Вам необходимо будет установить связь между торговыми посредниками с клиентами по языку Transact в центре партнеров.  Для этого отправьте им приглашение для подключения к вам в центре партнеров, как описано ниже.
...
При привлечения новых клиентов вам потребуется подключиться к ним в центре партнеров. Новых клиентов можно привлекать через различные каналы, например:
...
1.  Выберите **косвенные поставщики** в **меню центра партнеров**.
...
[Узнайте о поощрениях партнеров в центре партнеров](understand-incentive-payouts.md)
