...
- Несмотря на то, что администратора службы поддержки в центре партнеров невозможно создать запросы на обслуживание в портале обслуживания Azure, что они могут сделать — создать группу поддержку на портале службы Azure и предоставить разрешения для журнал запросы поддержки этой группы.
