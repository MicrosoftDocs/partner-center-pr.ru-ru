...
Все бесплатные пробные версии предоставляют 25 лицензий. Этот номер нельзя изменить во время пробной версии. Вы не можете добавлять или удалять лицензии в бесплатной пробной версии. После преобразования пробной версии в платную подписку можно добавить дополнительные лицензии.

Лицензии на пробные версии должны назначаться пользователям в рамках одной и той же лицензии платных служб.
...
2. В каталоге в поле **Частота выставления счетов** выберите **пробное предложение**. При этом отобразятся только бесплатные пробные версии, а платные предложения будут скрыты. Пробные версии отобразятся на вкладке **Пробные версии** в каталоге.
...
Бесплатная пробная версия не преобразуется автоматически в платную подписку. Через 30 дней бесплатную пробную версию необходимо преобразовать в платную подписку или срок ее [действия истечет](#expiring-offers). Бесплатные пробные версии не могут быть расширены.
...
4. Выставление счетов за платную подписку начинается с даты конвертации, а подписка — на 12 месяцев с даты преобразования. 
...
|----------------------------|:---------------------------------|:------------------------------------------|
|Пробная версия коммерческого облака Microsoft Teams (инициированная пользователем)   |Microsoft 365 бизнес Basic, Microsoft 365 бизнес Standard, Microsoft 365 бизнес Premium   | F3 (прежнее название — F1), Office 365 для предприятий (E1, E3 и F3), Microsoft 365 клавиша F1, 3, Microsoft 365 корпоративный (E3)   |
