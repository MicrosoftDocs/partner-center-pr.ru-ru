...
|----------------------------|:---------------------------------|:------------------------------------------|
|Пробная версия коммерческого облака Microsoft Teams (инициированная пользователем)   |Business Essentials, Бизнес-Premium, M365 Business   | F3 (ранее F1), Office 365 для предприятий (E1, E3 и M365), F1/F3, M365 Enterprise (E3)   |
