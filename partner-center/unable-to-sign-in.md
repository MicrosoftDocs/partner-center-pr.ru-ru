...
Если вы являетесь партнером Microsoft Partner Network (MPN), попросите своего глобального администратора создать новый пароль. Если вы являетесь непрямым торговым посредником поставщика облачных решений (CSP), попросите непрямого поставщика создать нового глобального администратора для вашего клиента Azure Active Directory (AD) или создайте новый пароль с помощью делегированных привилегий администратора.
