...
<tr class="even">
<td></td>
<td><p>¹ office 365 Business и Office 365 Business Essentials Индии могут обновляться до Office 365 Business Premium Индии, не для Office 365 бизнес премиум.</p></td>
</tr>
</tbody>
</table>
...
4.  Для переноса некоторых учетных записей пользователей для определенных служб могут потребоваться дополнительные действия. Если Да, партнерском центре список учетных записей и служб, которые были затронуты. Дополнительные сведения см. в статье базы знаний [Проблемы в переназначении лицензий при переключении планов в Office 365](https://go.microsoft.com/fwlink/p/?LinkId=723576).
