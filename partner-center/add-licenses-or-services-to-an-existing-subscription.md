...
<tr class="even">
<td></td>
<td><p>¹ Office365BusinessIndia и Office365BusinessEssentialsIndia можно обновить до Office365BusinessPremiumIndia, чтобы не Office365BusinessPremium.</p></td>
</tr>
</tbody>
</table>
...
4.  Для переноса некоторых учетных записей пользователей для определенных служб могут потребоваться дополнительные действия. Если это так, в центре партнеров представлен список учетных записей и служб, которые были затронуты. Дополнительные сведения см. в статье базы знаний [Проблемы в переназначении лицензий при переключении планов в Office365](http://go.microsoft.com/fwlink/p/?LinkId=723576).
