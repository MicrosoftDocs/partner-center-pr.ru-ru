...
в этой статье объясняется, как задать размер виртуальной машины (вм) для вычислительных потребностей клиентов при покупке Microsoft Azure резервирования для них.
 
> [!NOTE]
> эта статья относится только к партнерам в программе поставщик облачных решений (CSP). вместо этого клиенты, использующие другие типы подписок (например, оплата по мере использования, индивидуальные соглашения с клиентами майкрософт или подписки Соглашение Enterprise), должны читать [эту документацию по резервированию Azure](/azure/cost-management-billing/reservations).
...
2. Найдите клиента, желающего купить резервирования виртуальных машин Azure, а затем щелкните стрелку вниз, чтобы развернуть сведения о клиенте. выберите **Microsoft Azure портал управления** , чтобы открыть запись клиента в портал Azure.
...
2. Найдите клиента, для которого требуется проверить скидку резервирования и использование, а затем щелкните стрелку вниз, чтобы развернуть сведения о клиенте. выберите **Microsoft Azure портал управления** , чтобы открыть запись клиента в портал Azure.
