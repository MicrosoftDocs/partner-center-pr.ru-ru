...
5. После утверждения регистрации войдите в центр партнеров еще раз.
    ...
    > [!NOTE]
    > Хотя утверждение обычно осуществляется немедленно, это может занять до пяти рабочих дней. После утверждения вы получите уведомление по адресу электронной почты, указанному в разделе основное контактное лицо в форме регистрации. Вы также можете проверить состояние регистрации в разделе **Параметры**  >  **учетной записи**  >  **профиль партнера** > сведения о программе.
