...
1. Убедитесь, что профиль партнера в центре партнеров и идентификатор Microsoft Partner Network (MPN) являются актуальными.
...
7. Выберите **принять** (или **отклонить**), если это необходимо.
