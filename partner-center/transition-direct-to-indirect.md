...
### <a name="how-to-transition-to-indirect-reseller-status"></a>Как перейти к непрямому статусу торгового посредника
...
### <a name="indirect-provider-verify-transfer-request-is-complete"></a>Запрос на перенаправление проверки косвенного поставщика завершен
