...
4. Выберите зарегистрировать сейчас. Компания непрямого торгового посредника будет использовать тот же клиент AAD, который вы используете для вашего прямого бизнеса.
    ...
    > [!NOTE]
    > Информация, которую пользователь должен заметить, даже если Скиммингинитиалли, эта новая возможность перехода будет доступна для партнеров с датой сентября до декабря. Если у вас нет даты юбилея в диапазоне от сентября до декабря, эта возможность не будет отображаться в данный момент. Партнеры с датами юбилеев после декабря 2018 будут уведомлены позже, когда функция будет включена для участников.

5. После утверждения регистрации войдите в центр партнеров еще раз.

    > [!NOTE]
    > Информация, которую пользователь должен заметить, даже если утверждение Скиммингвхиле обычно осуществляется немедленно, может занять до пяти рабочих дней. После утверждения вы получите уведомление по адресу электронной почты, указанному в разделе основное контактное лицо в форме регистрации. Вы также можете проверить состояние регистрации в разделе **параметры** > **Параметры партнера** > **профиль партнера** > сведения о программе.
...
> [!IMPORTANT]
> Обязательные сведения, необходимые для пользователя Сукцессонце, зарегистрированного как непрямого торгового посредника с помощью новой возможности, нет возможности откатить к прямому клиенту только для выставления счетов. Прежде чем регистрировать непрямого торгового посредника, убедитесь, что вы полностью оцениваете бизнес-потребности.
