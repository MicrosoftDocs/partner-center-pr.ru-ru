...
Когда это произойдет, мы отправим электронное сообщение контакту, указанному в вашем [бизнес-профиле](create-a-marketing-profile.md) для конкретного региона и расположения. Также можно увидеть входящие затребования в центре партнеров: перейдите в раздел **центра партнеров > рекомендации > рекомендациями клиентов**.
