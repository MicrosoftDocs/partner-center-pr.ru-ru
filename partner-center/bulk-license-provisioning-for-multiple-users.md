...
1.  Выберите в меню **Центра партнеров** выберите **клиентов**и затем выберите клиента из списка.
...
8.  Выберите **Сохранить**. В центре партнеров откроется на странице подтверждения **обновление лицензиями** , списком пользователей и их новых лицензий.
