...
|API. Проверка идентификатора MPN партнера|[Проверка идентификатора MPN партнера](https://docs.microsoft.com/partner-center/develop/get-partner-by-mpn-id.md)