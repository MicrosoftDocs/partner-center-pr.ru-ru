...
Чтобы узнать больше, ознакомьтесь с [вопросами и ответами](https://docs.microsoft.com/partner-center/confirm-consent-faq) о подтверждении принятия пользователем условий Клиентского соглашения Майкрософт.
