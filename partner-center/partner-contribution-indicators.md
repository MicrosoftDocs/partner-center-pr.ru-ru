...
4. **Функциональный рост консультанта** — рост количества функциональных партнеров. Мы повторим оценку времени создания базового моментального снимка для этой метрики. Оно не будет выполняться 31 марта 2020, как было указано ранее. Когда мы настроили новую дату, мы будем обновлять этот документ, уведомлять вас в центре партнеров и через электронную почту.
