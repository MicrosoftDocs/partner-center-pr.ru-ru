...
Прежде чем начать этот процесс, вы должны ознакомиться со сведениями ниже.

### <a name="review-the-azure-marketplace-documentation"></a>Ознакомьтесь с документацией Azure Marketplace

Приведенные ниже статьи содержат сведения, которые необходимо изучить перед продолжением. 

- [Создание предложения Dynamics 365 for Customer Engagement & PowerApps](https://docs.microsoft.com/azure/marketplace/dynamics-365-customer-engage-offer-setup)
- [Создание коммерческой учетной записи Marketplace в центре партнеров](https://docs.microsoft.com/azure/marketplace/create-account)

### <a name="create-your-offer-id"></a>Создание идентификатора предложения
...
- Вы можете использовать только строчные буквы и цифры. Идентификатор предложения может включать дефисы и символы подчеркивания, но не пробелы. Например, если идентификатор издателя — тестпублишерид и вы вводите Test-предложение-1, веб-адрес предложения будет иметь значение https://appsource.microsoft.com/product/dynamics-365/testpublisherid.test-offer-1 .
- Этот идентификатор нельзя изменить после нажатия **создать**.

### <a name="create-your-offer-alias"></a>Создание псевдонима предложения
...
## <a name="register-isv-connect-deal-in-dealreg"></a>Регистрация беспроблемных подключений ISV в Деалрег

Следующим шагом является регистрация вашей сделки. Дополнительные сведения см. в разделе [регистрация сделок](https://docs.microsoft.com/partner-center/register-deals).
...
1. Войдите в [панель мониторинга Центра партнеров](https://partner.microsoft.com/dashboard/).
2. В меню навигации слева выберите **коммерческие рынки/обзор**.
3. Отфильтруйте **Отправленные** сделки, выберите вкладку **выполняется** , а затем выберите нужную сделку.
4. На странице Обзор для этой сделки выберите **Управление лицензиями**.
5. В окне **Управление лицензиями** выберите клиента в раскрывающемся списке **сведения о клиенте** . Если связь с клиентом еще не существует, выберите **+ пригласить нового клиента в согласие**.
6. Скопируйте отображаемую ссылку.
7. Отправьте эту ссылку администратору выставления счетов клиента или глобальному администратору по электронной почте и используйте эту ссылку для доступа к admin.microsoft.com и принятия и авторизации установленной связи.
...
После установки клиента можно приступить к добавлению планов из предложения и назначению лицензий каждому плану.
