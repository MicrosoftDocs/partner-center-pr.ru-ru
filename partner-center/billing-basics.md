...
ms.topic: article
ms.date: 11/25/2019
description: Сведения о базовой оплате и счетах для центра партнеров.
...
Ваш счет доступен в течение двух (2) дней выбранной даты выставления счетов в формате UTC. Например, если у вас дата выставления счетов — 12 сентября, процесс создания счета начнется в 00:00 (UTC) 13-го и завершится до 00:00 (UTC) 14-го. Если вы не видите счет на 11:59PM времени в формате UTC на 15-й странице, то у вас нет Соглашение об уровне обслуживания и он должен будет отправить запрос на обслуживание.
