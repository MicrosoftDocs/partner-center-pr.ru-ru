...
<td><ul>
<li>Счета-фактуры и файлы выверки можно просмотреть и загрузить на странице "Выставление счетов" информационной панели Центра партнеров. Обратите внимание, что месячные счета-фактуры становятся доступны в информационной панели Центра партнеров в течение четырех (4) дней после выбранной даты выставления счета.</li>
</ul></td>
</tr>
<tr class="odd">
...
#### <a name="download-a-credit-note"></a>Загрузите кредит-ноты

В случае, если вы воспользовались полный кредит (аннулировать счет) и счет, мы предоставим вам кредит-ноты для отмены исходной накладной и полной новый документ. Вы можете запросить кредит и повторному по следующим причинам:
-   Адрес или исправления заказа на покупку
-   Создаются счет-фактуру и затем была применена налоговый возврат средств. Вы можете запросить кредитной/счет для получения налоговый возврат денежных средств, полученное обратно в исходной накладной. Это также касается как возвраты денежных средств, как вы можете запросить кредит и повторному исходной накладной и извлечения в возврат средств.
