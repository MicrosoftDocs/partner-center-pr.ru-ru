...
| Создана выплата ISV | Определение тарифных выплат и доходов на выплаты | Помечается как необработанный в журнале транзакций в [отчете о выплатах](payout-statement.md) | **Месяц 3 (1-я неделя)** |
...
| **Дата выплаты** | **Платеж отправляется издателю** | **Помечается как отправленный в журнале транзакций и в разделе выплат [оператора выплаты](payout-statement.md)** | **Месяц 3 (не позднее 15)** |
...
| Создана выплата ISV | Определение тарифных выплат и доходов на выплаты | Помечается как необработанный в журнале транзакций в [отчете о выплатах](payout-statement.md) | **Месяц 2** |
| Период удержания в 30 дней | Обеспечение сбора фондов, возможных гибких и денежных запросов | Помечается как необработанный в журнале транзакций в [отчете о выплатах](payout-statement.md) | **Месяц 3** |
...
| **Дата выплаты** | **Платеж отправляется издателю** | **Помечается как отправленный в журнале транзакций и в разделе выплат [оператора выплаты](payout-statement.md)** | **Месяц 4 (не позднее 15)** |
|
