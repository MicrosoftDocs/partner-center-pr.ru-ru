...
<tr class="even">
<td>Tax</td>
<td><p>Сумма налоговых сборов, основанные на рынке & #39; правил налогообложения s и конкретных обстоятельств.</p></td>
<td>0</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>CustomerName</td>
<td><p>Клиент & #39; название организации s, указанное в центре партнеров. Это очень важно для выверки накладной с данными вашей системы.</p></td>
...
<tr class="even">
<td>DomainName</td>
<td><p>Клиент & #39; s доменное имя, используемое для идентификации клиента. Это не следует использовать для уникальной идентификации клиента, как клиенты и партнеры могут обновлять собственном/домена через портал Office 365. Это поле может быть пустым до второго цикла выставления счетов.</p></td>
...
<tr class="odd">
<td>DomainName</td>
<td><p>Клиент & #39; s доменное имя, используемое для идентификации клиента. Это поле может быть пустым до второго цикла выставления счетов.</p></td>
