...
В файле сверки может отобразиться отрицательная сумма. Возможно, это вызвано одной из следующих причин:
...
Чтобы получить дополнительные сведения об этой транзакции, проверьте атрибут типа оплаты в файле сверки.
