...
## <a name="why-cant-i-see-the-commercial-rewards-marketplace-program-on-my-dashboard"></a>Почему на панели мониторинга не отображается программа коммерческого вознаграждения?

Сведения о преимуществах Marketplace доступны через клиент Azure AD и идентификатор MPN, который использовался для создания учетной записи центра партнеров. Эта учетная запись называется основной глобальной учетной записью (PGA) вашей компании. Если клиент AAD отличается от того, который используется для адаптации MPN, то для просмотра меню коммерческого вознаграждения необходимо связать его с PGA компании. 
