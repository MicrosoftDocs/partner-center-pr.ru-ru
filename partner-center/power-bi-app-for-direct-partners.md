...
---
# <a name="faqs-for-the-partner-center-analytics-app-for-power-bi"></a>Вопросы и ответы по приложению аналитики центра партнеров для Power BI
...
Получите визуальное представление бизнес-данных с помощью приложения аналитики центра партнеров для Microsoft Power BI. Приложение, предназначенное для прямых партнеров в программе поставщика облачных решений (CSP), подключается к знакомой Power BI Framework.
...
| Можно ли использовать приложение для просмотра данных из нескольких клиентов Azure Active Directory (Azure AD) в разных расположениях? | В этом выпуске вы можете просматривать только данные клиента Azure AD, в который выполнил вход глобальный администратор или агент администратора. | 
