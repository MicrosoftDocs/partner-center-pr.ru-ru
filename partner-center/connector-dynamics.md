...
Созданы две переменные среды:

- Флажок: указывает, нужен ли значок флажка, помимо возможностей, которые синхронизируются двунаправленно между центром партнеров и Dynamics 365 CRM.

- Синхронизировать только возможности совместной продажи: указывает, нужно ли синхронизировать только возможности совместной продажи.

Можно изменить значение по умолчанию для переменных среды.
...
Обновите форму возможности в Dynamics 365 CRM, чтобы включить решения для поля продукты.
