...
| кредитперцентаже | Отображает кредит потребления Azure. Заработанный кредит будет равняться 0 или 100%. |
| кредиттипе | Тип кредита. Например, **применяется кредит Azure.** |
>[!NOTE]
