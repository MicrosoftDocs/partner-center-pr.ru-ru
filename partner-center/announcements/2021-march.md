...
### <a name="summary"></a><span data-ttu-id="8cf3f-109">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-109">Summary</span></span>
...
|<span data-ttu-id="8cf3f-135">Неполные сведения о здании</span><span class="sxs-lookup"><span data-stu-id="8cf3f-135">Premises partial</span></span> | <span data-ttu-id="8cf3f-136">Указаны неполные сведения о здании (номер дома, номер квартиры и т. д.). Требуется дополнительная информация.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-136">The given premises (building number, suite number, and others) are partial and need more info.</span></span> | <span data-ttu-id="8cf3f-137">Несколько (не более трех)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-137">Multiple—maximum of three</span></span> |
...
- <span data-ttu-id="8cf3f-157">31 марта 2020 г. — исходная публикация.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-157">March 31, 2020: Original publication</span></span>
...
<span data-ttu-id="8cf3f-171">Преимущества нового интерфейса EAC:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-171">Benefits of the new EAC include:</span></span>
...
### <a name="categories"></a><span data-ttu-id="8cf3f-184">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-184">Categories</span></span>
...
### <a name="questions"></a><span data-ttu-id="8cf3f-211">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-211">Questions?</span></span>
...
1. <span data-ttu-id="8cf3f-225">партнер, напрямую получающий счета от Майкрософт (то есть партнер с прямым выставлением счетов или косвенный поставщик);</span><span class="sxs-lookup"><span data-stu-id="8cf3f-225">The partner has a direct billing relationship with Microsoft (which means that the partner is either a direct bill partner or an indirect provider).</span></span>
...
- <span data-ttu-id="8cf3f-244">Армения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-244">Armenia</span></span>
...
### <a name="questions"></a><span data-ttu-id="8cf3f-262">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-262">Questions?</span></span>
...
- <span data-ttu-id="8cf3f-276">идентификатор продукта: DF77X4D43RKT;</span><span class="sxs-lookup"><span data-stu-id="8cf3f-276">Product ID: DF77X4D43RKT</span></span> 
...
### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-288">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-288">Impacted audience</span></span>
...
- <span data-ttu-id="8cf3f-299">Новый тип ресурса CustomerDirectoryRole.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-299">New resource type “CustomerDirectoryRole”</span></span>
...
- <span data-ttu-id="8cf3f-310">Приобретение и управление:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-310">Purchase and Manage:</span></span>
  ...
  - <span data-ttu-id="8cf3f-316">POST /customers/{идентификатор_клиента}/subscriptions/{идентификатор_подписки}/transitions</span><span class="sxs-lookup"><span data-stu-id="8cf3f-316">POST /customers/{customerId}/subscriptions/{subscriptionId}/transitions</span></span>
...
- <span data-ttu-id="8cf3f-343">Воспользуйтесь [API](/partner-center/develop/create-subscription-azure-marketplace-products#get-a-list-of-offers-for-a-market) для интеграции приложений нас страницу своей компании на коммерческой платформе.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-343">Use [APIs](/partner-center/develop/create-subscription-azure-marketplace-products#get-a-list-of-offers-for-a-market) to integrate apps into your company’s marketplace</span></span>
...
|   <span data-ttu-id="8cf3f-379">Office 365 E5 без аудиоконференций (расценки для некоммерческих организаций)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-379">Office 365 E5 without Audio Conferencing (Nonprofit Staff Pricing)</span></span>|  <span data-ttu-id="8cf3f-380">c3897426-9f49-4eaf-9b4d-7d9a1c72aef7</span><span class="sxs-lookup"><span data-stu-id="8cf3f-380">c3897426-9f49-4eaf-9b4d-7d9a1c72aef7</span></span>|
...
<span data-ttu-id="8cf3f-400">Были исправлены неверные цены за март 2021 г. для Microsoft 365 F3 в фунтах стерлингов (GBP) и евро (EUR).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-400">Incorrect March 2021 pricing has been corrected for Microsoft 365 F3 British Pound (GBP) and Euro (EUR).</span></span>
...
### <a name="questions"></a><span data-ttu-id="8cf3f-423">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-423">Questions?</span></span>
...
<span data-ttu-id="8cf3f-437">Дополнительные сведения см. в разделе [Обновление юридического бизнес-профиля](../update-your-partner-profile.md#update-your-legal-business-profile).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-437">To learn more, see [Update your legal business profile](../update-your-partner-profile.md#update-your-legal-business-profile).</span></span>
...
<span data-ttu-id="8cf3f-449">В рамках программы "Поставщик облачных решений" (CSP) станут доступны новые предложения программного обеспечения с бессрочной лицензией для коммерческого и государственного секторов, а в программу Open License будут внесены изменения.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-449">New commercial and public sector perpetual software offers are coming to the Cloud Solution Provider (CSP) program along with changes to the Open Licensing program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-450">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-450">Impacted audience</span></span>

<span data-ttu-id="8cf3f-451">Коммерческие дистрибьюторы и управляемые торговые посредники, которые ведут продажи в рамках программы Open License, а также все партнеры CSP, предоставляющие программное обеспечение с бессрочной лицензией.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-451">Commercial distributors and managed resellers selling through the Open License program, as well as all CSP partners transacting perpetual software</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-452">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-452">Details</span></span>

<span data-ttu-id="8cf3f-453">В сентябре 2020 г. корпорация Майкрософт [объявила](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/) о новых мероприятиях по поддержке цифровой трансформации, которые расширяют возможности партнеров по программе CSP, в том числе о доступе к локальному программному обеспечению для партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-453">In September 2020, Microsoft [announced](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/) a series of steps in our digital transformation journey to expand opportunities to partners in the CSP program, including the availability of on-premises software for partners.</span></span> <span data-ttu-id="8cf3f-454">Эти нововведения помогут партнерам в развитии бизнеса и увеличении охвата с помощью лицензий на программное обеспечение в рамках CSP, а также в достижении успеха в современном облачном мире.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-454">These changes enable partners to grow their business and extend their reach by leveraging software licenses in CSP, positioning them for success in today’s cloud-first world.</span></span> <span data-ttu-id="8cf3f-455">Они также ускорят переход клиентов в облако и предоставят партнерам необходимую гибкость для работы с гибридными облачными средами клиентов.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-455">They also empower customers’ transitions to the cloud and give partners the flexibility needed for customer hybrid cloud environments.</span></span>

<span data-ttu-id="8cf3f-456">В рамках дальнейшей цифровой трансформации мы объявляем о следующих изменениях:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-456">In continuation of this digital transformation, we are announcing the following changes:</span></span>

- <span data-ttu-id="8cf3f-457">1 июля 2021 г.: в прейскурант программы Open License не будут добавляться новые SKU, продукты или акции.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-457">July 1, 2021:  No new SKUs, products, or promotions will be added to the Open License program price list.</span></span>

- <span data-ttu-id="8cf3f-458">7 июля 2021 г.: в прейскурант программного обеспечения с бессрочной лицензией в рамках CSP будут добавлены два коммерческих предложения (Get Genuine Windows и Visual Studio Professional), а также предложения для государственного сектора (правительственных, образовательных и некоммерческих организаций — см. [объявление](./2020-december.md#9)).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-458">July 7, 2021:  Two commercial offers, Get Genuine Windows and Visual Studio Professional, and public sector offers (government, education and nonprofit – see [announcement](./2020-december.md#9)) will be added to the CSP perpetual software price list.</span></span>  <span data-ttu-id="8cf3f-459">Прейскурант можно найти в разделе "Программное обеспечение" на странице [Продажи > Цены и предложения](https://partnercenter.microsoft.com/pcv/sales) в Центре партнеров. В этот день он будет опубликован повторно.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-459">The price list can be found in the Software section of the [Sell > Pricing & Offers](https://partnercenter.microsoft.com/pcv/sales) page in Partner Center and will be republished on this date.</span></span>

<span data-ttu-id="8cf3f-460">Ссылки на статьи с полными сведениями об изменениях в программах CSP и Open License см. в разделе **Дальнейшие действия** ниже.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-460">For full details regarding the CSP program evolution and Open License program changes, please see **Next Steps** below.</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-461">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-461">Next Steps:</span></span>

- <span data-ttu-id="8cf3f-462">Изменения в программе CSP: просмотрите материалы по подготовке [Бессрочное лицензирование ПО в рамках программы "Поставщик облачных решений" (CSP)](https://partner.microsoft.com/resources/collection/software-in-csp#/).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-462">CSP Program evolution:  Review the [Perpetual software in the Cloud Solution Provider program](https://partner.microsoft.com/resources/collection/software-in-csp#/) readiness materials.</span></span> <span data-ttu-id="8cf3f-463">Воспользуйтесь этой [картой готовности](https://partner.microsoft.com/resources/detail/software-in-csp-readiness-map-pdf), чтобы быстро найти нужную информацию для своей роли.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-463">Use this [readiness map](https://partner.microsoft.com/resources/detail/software-in-csp-readiness-map-pdf) to quickly locate the right information for your role.</span></span>

- <span data-ttu-id="8cf3f-464">Изменения в программе Open License: просмотрите материалы по подготовке [Изменения в программе CSP и в программе Open License](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-464">Open License program changes:  Review the [CSP program evolution and Open License program changes](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) readiness materials.</span></span> <span data-ttu-id="8cf3f-465">Воспользуйтесь этой [картой готовности](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf), чтобы быстро найти нужную информацию для своей роли.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-465">Use this [readiness map](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) to quickly locate the right information for your role.</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-466">Вопросы</span><span class="sxs-lookup"><span data-stu-id="8cf3f-466">Questions</span></span>

<span data-ttu-id="8cf3f-467">С вопросами обращайтесь в соответствующее сообщество CSP в Yammer.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-467">For any further questions please check your relevant CSP Yammer communities.</span></span>

_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="8"></a><span data-ttu-id="8cf3f-468">Обновление предыдущего объявления о выпуске решения "Оценки" категории "Премиум" — надстройки к диспетчеру соответствия требованиям</span><span class="sxs-lookup"><span data-stu-id="8cf3f-468">Update to a previous announcement: Premium Assessments, an add-on to Compliance Manager</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-469">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-469">Categories</span></span>

- <span data-ttu-id="8cf3f-470">Дата: 15.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-470">Date: 2021-03-15</span></span>
- <span data-ttu-id="8cf3f-471">Рост вашего бизнеса</span><span class="sxs-lookup"><span data-stu-id="8cf3f-471">Grow your business</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-472">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-472">Summary</span></span>

<span data-ttu-id="8cf3f-473">Пробные версии не должны указываться в прейскуранте и будут удалены.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-473">The trial offers shouldn’t have been listed on the price list and will be removed.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-474">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-474">Impacted audience</span></span>

<span data-ttu-id="8cf3f-475">Партнеры, заключающие сделки в рамках программы "Поставщик облачных решений" (CSP).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-475">Partners transacting through Cloud Solution Provider</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-476">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-476">Details</span></span>

<span data-ttu-id="8cf3f-477">Пробные версии не должны указываться в прейскуранте.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-477">The trial offers shouldn’t have been included in the price list.</span></span> <span data-ttu-id="8cf3f-478">1 мая 2021 г. они будут удалены из него.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-478">These will be removed from the May 1, 2021 price list.</span></span>

<span data-ttu-id="8cf3f-479">Первоначальное объявление можно найти [здесь](./2021-february.md#4).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-479">The original announcement is [here](./2021-february.md#4).</span></span>

### <a name="additional-resources"></a><span data-ttu-id="8cf3f-480">Дополнительные ресурсы</span><span class="sxs-lookup"><span data-stu-id="8cf3f-480">Additional resources</span></span>

- [<span data-ttu-id="8cf3f-481">Безопасность и соответствие требованиям Microsoft 365 E5</span><span class="sxs-lookup"><span data-stu-id="8cf3f-481">Microsoft 365 E5 security and compliance</span></span>](https://www.microsoft.com/licensing/product-licensing/microsoft-365-enterprise?activetab=m365-enterprise:primaryr5)

- [<span data-ttu-id="8cf3f-482">Создание оценок и управление ими в диспетчере соответствия требованиям (Майкрософт) — Центр соответствия Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="8cf3f-482">Build and manage assessments in Microsoft Compliance Manager - Microsoft 365 Compliance</span></span>](/microsoft-365/compliance/compliance-manager-assessments)

### <a name="next-steps"></a><span data-ttu-id="8cf3f-483">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-483">Next steps</span></span>

<span data-ttu-id="8cf3f-484">Изучите доступные ресурсы и на эту тему поделитесь этой информацией с соответствующими заинтересованными лицами в своей организации.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-484">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-485">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-485">Questions?</span></span>

<span data-ttu-id="8cf3f-486">С любыми вопросами по этим предложениям обращайтесь в соответствующее сообщество в Yammer.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-486">For questions about these offers, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-solutions-from-one-commercial-partner-ocp-go-to-market-gtm-to-the-microsoft-commercial-marketplace"></a><a name="7"></a> <span data-ttu-id="8cf3f-487">Перенос решений из средства вывода на рынок (GTM) для One Commercial Partner (OCP) на коммерческую платформу Майкрософт</span><span class="sxs-lookup"><span data-stu-id="8cf3f-487">Migrate your solutions from One Commercial Partner (OCP) go-to market (GTM) to the Microsoft commercial marketplace</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-488">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-488">Categories</span></span>

- <span data-ttu-id="8cf3f-489">Дата: 12.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-489">Date: 2021-03-12</span></span>
- <span data-ttu-id="8cf3f-490">Возможности</span><span class="sxs-lookup"><span data-stu-id="8cf3f-490">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-491">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-491">Summary</span></span>

<span data-ttu-id="8cf3f-492">С 29 марта 2021 г. возможности One Commercial Partner (OCP) в средстве вывода на рынок (GTM) будут ограничены.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-492">From March 29, 2021, you will begin to experience limited One Commercial Partner (OCP) go-to market (GTM) capabilities.</span></span> <span data-ttu-id="8cf3f-493">Рекомендуем вам перенести свои решения на коммерческую платформу в Центре партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-493">We encourage you to migrate your solutions to the commercial marketplace in Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-494">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-494">Impacted audience</span></span>

<span data-ttu-id="8cf3f-495">Организации, ведущие совместные продажи с решениями в OCP GTM.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-495">Organizations co-selling with solutions in OCP GTM</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-496">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-496">Details</span></span>

<span data-ttu-id="8cf3f-497">В декабре 2020 г. мы начали переход со средства Microsoft OCP GTM на коммерческую платформу Майкрософт в Центре партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-497">In December 2020, we started our journey from the Microsoft OCP GTM tool to the Microsoft commercial marketplace in Partner Center.</span></span> <span data-ttu-id="8cf3f-498">Это позволит расширить возможности коммерческой платформы, на которой вы можете предоставлять свои решения миллионам клиентов, обмениваться информацией с другими специалистами по продажам Майкрософт и партнерами, а также совместно продавать инновационные решения.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-498">This transition expands the capabilities of the commercial marketplace where you can showcase your solutions to millions of customers, bidirectionally share opportunities with other Microsoft and partner sellers, and jointly sell innovative solutions.</span></span>

<span data-ttu-id="8cf3f-499">Следующий этап перехода запланирован на 29 марта 2021 г.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-499">The next milestone in the transition will take place on March 29, 2021.</span></span> <span data-ttu-id="8cf3f-500">Именно с этой даты возможности OCP GTM будут ограничены — некоторые поля станут доступны только для чтения.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-500">That’s when you’ll begin to experience limited OCP GTM capabilities, with some fields becoming read-only.</span></span> <span data-ttu-id="8cf3f-501">Если вы сейчас ведете совместные продажи с решениями в OCP GTM, рекомендуем вам перенести решения на коммерческую платформу, чтобы воспользоваться всеми ее преимуществами и упростить процесс публикации.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-501">If you’re currently co-selling with solutions in OCP GTM, we encourage you to migrate your solutions to the commercial marketplace to take advantage of its capabilities and simplify your publishing experience.</span></span>

<span data-ttu-id="8cf3f-502">После перехода на коммерческую платформу Центр партнеров станет основным порталом для публикации и совместных продаж.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-502">Moving to the commercial marketplace makes Partner Center the primary destination for the co-sell publishing experience.</span></span> <span data-ttu-id="8cf3f-503">С ее помощью вы сможете ускорить рост бизнеса, расширив охват для продажи своих решений нашим общим клиентам с помощью знакомых вам каналов и возможностей, которые мы используем для продуктов Майкрософт.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-503">It’s where you can continue to grow your business by connecting your solutions with our shared customers through the same channels and in-product experiences that we use for Microsoft products.</span></span> <span data-ttu-id="8cf3f-504">[Подробнее о коммерческой платформе.](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-504">[Learn more about the commercial marketplace](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-505">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-505">Next steps</span></span>

- <span data-ttu-id="8cf3f-506">Если вы еще не переместили свои решения, следуйте инструкциям из [руководства по переходу](/azure/marketplace/co-sell-solution-migration) или посмотрите [видеоучебник с пошаговыми инструкциями](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4), чтобы выполнить все шаги миграции и начать публиковать свои решения на коммерческой платформе.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-506">If you have not yet moved your solutions, follow the instructions detailed in the [transition guide](/azure/marketplace/co-sell-solution-migration) or view the [step-by-step video tutorial](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4) to complete all migration activities and start publishing your solution(s) in the commercial marketplace.</span></span>

- <span data-ttu-id="8cf3f-507">Вопросы, касающиеся ограниченных возможностей в OCP GTM, см. в [статье с вопросами и ответами о требованиях к совместным продажам для публикации на коммерческой платформе Майкрософт](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-507">For questions regarding the limited capability experience in OCP GTM, view the [Co-sell requirements to publish in the Microsoft commercial marketplace FAQ](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf).</span></span> <span data-ttu-id="8cf3f-508">(см. раздел "Ограниченные возможности в OCP GTM с 29 марта 2021 г.).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-508">(See the section “OCP GTM limited capabilities starting March 29, 2021.”)</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-509">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-509">Questions?</span></span>

<span data-ttu-id="8cf3f-510">Если у вас возникнут вопросы или вам потребуется дополнительная информация, обратитесь в [службу поддержки](https://partner.microsoft.com/support/?stage=1).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-510">Contact [Support](https://partner.microsoft.com/support/?stage=1) if you have any questions or need more information.</span></span>

________________
## <a name="programmatic-access-to-commercial-marketplace-analytics"></a><a name="6"></a><span data-ttu-id="8cf3f-511">Программный доступ к аналитике коммерческой платформы</span><span class="sxs-lookup"><span data-stu-id="8cf3f-511">Programmatic access to commercial marketplace analytics</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-512">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-512">Categories</span></span>

- <span data-ttu-id="8cf3f-513">Дата: 10.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-513">Date: 2021-03-10</span></span>
- <span data-ttu-id="8cf3f-514">Характеристики</span><span class="sxs-lookup"><span data-stu-id="8cf3f-514">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-515">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-515">Summary</span></span>

<span data-ttu-id="8cf3f-516">Теперь партнеры могут получать аналитические отчеты для мониторинга продаж, оценки производительности и оптимизации предложений на коммерческой платформе программными средствами.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-516">Partners can now programmatically access analytics reports to monitor sales, evaluate performance, and optimize offers in the commercial marketplace.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-517">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-517">Impacted audience</span></span>

<span data-ttu-id="8cf3f-518">Партнеры с предложениями на коммерческой платформе.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-518">Partners with offers in the commercial marketplace.</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-519">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-519">Details</span></span>

<span data-ttu-id="8cf3f-520">API-интерфейсы для доступа к отчетам коммерческой платформы позволяют создать расписание для асинхронного получения настраиваемых отчетов по данным аналитики.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-520">The API for accessing commercial marketplace reports enable you to schedule custom reports of your analytics data asynchronously.</span></span>

<span data-ttu-id="8cf3f-521">Эта возможность позволяет определять запросы и шаблоны для отчетов в соответствии с собственными потребностями, а также настраивать расписание их выполнения, чтобы своевременно получать надежные отчеты по удобному графику.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-521">The capability enables you to define reporting queries and templates based on your needs, set a schedule, and get timely and trustworthy reports at scheduled intervals.</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-522">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-522">Next steps</span></span>

<span data-ttu-id="8cf3f-523">Дополнительные сведения см. в статье [Приступая к работе с программным доступом к аналитике](/azure/marketplace/analytics-get-started).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-523">To learn more, see [Get started with programmatic access to analytics](/azure/marketplace/analytics-get-started).</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-524">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-524">Questions?</span></span>

<span data-ttu-id="8cf3f-525">Если у вас возникнут дополнительные вопросы, обращайтесь в [службу поддержки](https://go.microsoft.com/fwlink/?linkid=2165533).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-525">Contact [Support](https://go.microsoft.com/fwlink/?linkid=2165533) if you have any further questions.</span></span>

________________
## <a name="expanding-the-new-commerce-experience-in-the-cloud-solution-provider-csp-program-for-azure-to-russia"></a><a name="5"></a><span data-ttu-id="8cf3f-526">Развертывание новой коммерческой платформы в рамках программы "Поставщик облачных решений" (CSP) для Azure в России</span><span class="sxs-lookup"><span data-stu-id="8cf3f-526">Expanding the new commerce experience in the Cloud Solution Provider (CSP) program for Azure to Russia</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-527">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-527">Categories</span></span>

- <span data-ttu-id="8cf3f-528">Дата: 10.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-528">Date: 2021-03-10</span></span>
- <span data-ttu-id="8cf3f-529">Характеристики</span><span class="sxs-lookup"><span data-stu-id="8cf3f-529">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-530">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-530">Impacted audience</span></span>

<span data-ttu-id="8cf3f-531">Все партнеры в России, заключающие сделки в рамках программы "Поставщик облачных решений" (CSP).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-531">All partners in Russia transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-532">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-532">Details</span></span>

<span data-ttu-id="8cf3f-533">Начиная с 10 марта 2021 г. мы предоставляем доступ к **новому интерфейсу коммерческой платформы для партнеров по программе CSP, которые работают с Azure в России**.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-533">Starting March 10 2021, we’re excited to announce the availability of the **new commerce experience in CSP for Azure in Russia**.</span></span> <span data-ttu-id="8cf3f-534">Этот интерфейс упростит и улучшит приобретение и использование клиентами служб Azure.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-534">This experience will streamline and improve the way customers buy and consume Azure services.</span></span> <span data-ttu-id="8cf3f-535">Он также предоставит партнерам по программе CSP согласованное представление с ценами на коммерческие предложения в Azure, с ценами в долларах США (для согласованности с мировым рынком), данные о датах выставления счетов и доступ к Управлению затратами в Azure.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-535">It will also give partners in the CSP program a consistent view of Azure pricing across sales motions, USD pricing for global consistency, billing date alignment, and access to Azure Cost Management.</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-536">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-536">Next steps</span></span>

<span data-ttu-id="8cf3f-537">Мы подготовили несколько ресурсов, которые познакомят вас с новым интерфейсом коммерческой платформы для Azure и содержат дополнительные сведения.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-537">There are several resources available introducing the new Azure commerce experience and providing additional information.</span></span> <span data-ttu-id="8cf3f-538">Последние вопросы и ответы, презентации, видео и другие материалы можно найти в [коллекции ресурсов с обновлениями по программе CSP](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-538">Find the latest FAQs, decks, video and more in the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span></span>

________________
## <a name="partner-center-software-license-key-and-download-fulfillment"></a><a name="4"></a><span data-ttu-id="8cf3f-539">Обработка лицензионных ключей и скачивание программного обеспечения в Центре партнеров</span><span class="sxs-lookup"><span data-stu-id="8cf3f-539">Partner Center software license key and download fulfillment</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-540">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-540">Categories</span></span>

- <span data-ttu-id="8cf3f-541">Дата: 04.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-541">Date: 2021-03-04</span></span>
- <span data-ttu-id="8cf3f-542">Возможности</span><span class="sxs-lookup"><span data-stu-id="8cf3f-542">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-543">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-543">Summary</span></span>

<span data-ttu-id="8cf3f-544">Возможность скачивания программного обеспечения и обработки лицензионных ключей в Центре партнеров восстановлена.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-544">The Partner Center software download and license key fulfillment capability has been reinstated.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-545">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-545">Impacted audience</span></span>

<span data-ttu-id="8cf3f-546">Все партнеры в рамках программы "Поставщик облачных решений" (CSP), заключающие сделки по заказам на программное обеспечение по бессрочной и серверной подписке через Центр партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-546">All Cloud Solution Provider (CSP) partners transacting perpetual and server subscription software orders through Partner Center</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-547">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-547">Details</span></span>

<span data-ttu-id="8cf3f-548">В ответ на отзывы партнеров мы восстанавливаем возможности Центра партнеров по получению программного обеспечения и лицензионных ключей в рамках заказов на программное обеспечение по бессрочной и серверной подписке.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-548">In response to partner feedback, we’re reinstating the Partner Center fulfillment capability to obtain software and license keys for perpetual and server subscription software orders.</span></span> <span data-ttu-id="8cf3f-549">Эта возможность будет восстановлена до состояния перед ее удалением 19 января 2021 г.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-549">It will be restored to its previous state prior to being removed on January 19, 2021.</span></span> <span data-ttu-id="8cf3f-550">(См. [объявление](2020-september.md#17).)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-550">(See the [announcement](2020-september.md#17).)</span></span>

<span data-ttu-id="8cf3f-551">Учтите, что лицензионные ключи и ссылки на скачивание программного обеспечения — это ценные и востребованные активы интеллектуальной собственности.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-551">Note that software license keys and download links are valuable and highly sought-after intellectual property assets.</span></span> <span data-ttu-id="8cf3f-552">В случае их утечки доступные активации могут быстро закончиться, а работа клиентов и партнеров ухудшится.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-552">If leaked, they can quickly be depleted of their activation limits and cause a negative customer and partner experience.</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-553">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-553">Next steps</span></span>

<span data-ttu-id="8cf3f-554">Инструкции по использованию и важные рекомендации по распространению ключей программного обеспечения см. в следующих ресурсах:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-554">Review the following resources for usage instructions and important guidance on software key distribution:</span></span>

- [<span data-ttu-id="8cf3f-555">Продажа локального программного обеспечения через программу CSP</span><span class="sxs-lookup"><span data-stu-id="8cf3f-555">Sell on-premises software through the CSP program</span></span>](../csp-on-premise-software.md)
- <span data-ttu-id="8cf3f-556">[Новое руководство по коммерческим операциям в Центре партнеров](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (см. раздел **Рекомендации по распространению ключей программного обеспечения**).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-556">[Partner Center New Commerce Operations Guide](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (See the **Guidance on Software Key Distribution** section.)</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-557">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-557">Questions?</span></span>

<span data-ttu-id="8cf3f-558">Если у вас есть дополнительные вопросы по этому уведомлению, обращайтесь в соответствующее сообщество в Yammer.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-558">If you have any further questions about this notice, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-deals-from-partner-sales-connect-psc-to-partner-center"></a><a name="3"></a><span data-ttu-id="8cf3f-559">Перенос сделок из Partner Sales Connect (PSC) в Центр партнеров</span><span class="sxs-lookup"><span data-stu-id="8cf3f-559">Migrate your deals from Partner Sales Connect (PSC) to Partner Center</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-560">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-560">Categories</span></span>

- <span data-ttu-id="8cf3f-561">Дата: 04.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-561">Date: 2021-03-04</span></span>
- <span data-ttu-id="8cf3f-562">Возможности</span><span class="sxs-lookup"><span data-stu-id="8cf3f-562">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-563">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-563">Summary</span></span>

<span data-ttu-id="8cf3f-564">С 31 марта 2021 г. портал Partner Sales Connect (PSC) будет доступен только для чтения, поэтому мы настоятельно рекомендуем вам начать перенос сделок из PSC в Центр партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-564">Partner Sales Connect (PSC) will move to read-only access starting March 31, 2021, so we urge you to begin migrating your deals from PSC to Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-565">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-565">Impacted audience</span></span>

<span data-ttu-id="8cf3f-566">Партнеры, у которых есть сделки в PSC</span><span class="sxs-lookup"><span data-stu-id="8cf3f-566">Partners with deals in PSC</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-567">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-567">Details</span></span>

<span data-ttu-id="8cf3f-568">В рамках нашего общего стремления к развитию **совместные продажи с Майкрософт** — это способ, благодаря которому вы можете **заявить о себе, поделиться своим опытом и расширить круг своих клиентов** для получения положительных результатов работы с клиентами.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-568">As part of our shared commitment to growth, **co-sell with Microsoft** is the path for you to **be discovered, deliver your expertise, and expand your customer footprint** for positive customer outcomes.</span></span> <span data-ttu-id="8cf3f-569">При средней скорости заключения сделки, которая в **3,5 раза выше**, чем обычно, управление совместными продажами в Центре партнеров позволяет вам осуществлять продажи через прямые каналы клиентов, партнеров и специалистов Майкрософт по продажам, а также управлять всей цепочкой клиентов по рекомендации в одном расположении.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-569">With an average deal that’s **3.5 times faster** than normal, managing your co-sell experience in Partner Center allows you to sell across the direct customer, partner, and Microsoft seller channels, and manage your entire referral pipeline in one location.</span></span>

<span data-ttu-id="8cf3f-570">С **31 марта 2021 г.** портал **PSC** будет **доступен только для чтения**, поэтому мы настоятельно рекомендуем вам начать перенос сделок из PSC в Центр партнеров, чтобы использовать следующие улучшенные возможности:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-570">**PSC** will move to **read-only access** starting **March 31, 2021**, so we urge you to start your move to Partner Center and access these capability improvements:</span></span> 

- <span data-ttu-id="8cf3f-571">**более точное направление сделок**, которые вы ведете совместно с Майкрософт, к нужному продавцу в зависимости от типа необходимой вам помощи;</span><span class="sxs-lookup"><span data-stu-id="8cf3f-571">**More accurate routing** of the deals that you share with Microsoft to the right seller, based on the type of assistance you need.</span></span>
- <span data-ttu-id="8cf3f-572">**предварительная проверка соответствия сделки** для решений, на которые распространяется программа поощрения, а также для соответствия критериям программы ISV Connect, что упрощает процесс утверждения и окончательное подтверждение выполнения (POE);</span><span class="sxs-lookup"><span data-stu-id="8cf3f-572">**Upfront deal eligibility validation** for incentive-eligible solutions and to meet the ISV Connect program criteria, simplifying the approval process and final proof of execution (POE) attestation.</span></span>
- <span data-ttu-id="8cf3f-573">**удобный пользовательский интерфейс** для централизованного управления всеми возможными сделками, а также клиентами с подтвержденной потребностью в продукте или услуге компании в рамках совместных продаж.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-573">**Seamless user experience** to manage all your co-sell opportunities and sales qualified leads in one place.</span></span>

<span data-ttu-id="8cf3f-574">Кроме того, недавно мы добавили в Центр партнеров новые функции, которые помогут вам при миграции:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-574">We’ve also recently added new features in Partner Center to assist in your move:</span></span>

- <span data-ttu-id="8cf3f-575">[массовые операции для возможных сделок в рамках совместных продаж](../bulk-operations.md);</span><span class="sxs-lookup"><span data-stu-id="8cf3f-575">[Bulk operations for co-sell opportunities](../bulk-operations.md)</span></span>
- <span data-ttu-id="8cf3f-576">[функция переноса сделок](../psc-to-pc.md) (см. раздел о **переносе сделок из PSC**).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-576">[Deal migration feature](../psc-to-pc.md) (See the **PSC Deals migration** section.)</span></span>

<span data-ttu-id="8cf3f-577">Используя возможности совместной продажи в Центре партнеров, ваши специалисты по продажам смогут сосредоточиться на тщательной проработке потенциальных клиентов и возможных сделок, закрытии сделок и создании долгосрочных отношений с клиентами.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-577">Using the co-sell experience in Partner Center, your sales teams will have more time to focus on nurturing leads and opportunities, closing deals, and creating lasting customer relationships.</span></span>

### <a name="next-steps"></a><span data-ttu-id="8cf3f-578">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-578">Next steps</span></span>

<span data-ttu-id="8cf3f-579">Прочтите [руководство по переходу](../psc-to-pc.md) в Центр партнеров, чтобы получить пошаговые инструкции по переносу сделок из PSC в Центр партнеров.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-579">Use the Partner Center [transition guide](../psc-to-pc.md) to walk you through the steps to migrate your deals from PSC to Partner Center.</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-580">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-580">Questions?</span></span>

<span data-ttu-id="8cf3f-581">Если у вас есть дополнительные вопросы, обращайтесь в [службу поддержки](https://partner.microsoft.com/support/?stage=1).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-581">For any further questions, contact [Support](https://partner.microsoft.com/support/?stage=1).</span></span>

________________
## <a name="new-microsoft-dynamics-365-products-and-offers-available-on-april-1-2021"></a><a name="2"></a><span data-ttu-id="8cf3f-582">Новые продукты и предложения Microsoft Dynamics 365, которые станут доступны 1 апреля 2021 г.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-582">New Microsoft Dynamics 365 products and offers available on April 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-583">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-583">Categories</span></span>

- <span data-ttu-id="8cf3f-584">Дата: 04.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-584">Date: 2021-03-04</span></span>
- <span data-ttu-id="8cf3f-585">Возможности</span><span class="sxs-lookup"><span data-stu-id="8cf3f-585">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-586">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-586">Summary</span></span>

<span data-ttu-id="8cf3f-587">1 апреля 2021 г. корпорация Майкрософт выпустит несколько новых продуктов и предложений в рамках программы "Поставщик облачных решений" (CSP).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-587">On April 1, 2021, Microsoft will be launching several new products and offers for the Cloud Solution Provider (CSP) program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-588">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-588">Impacted audience</span></span>

<span data-ttu-id="8cf3f-589">Все партнеры, заключающие сделки в рамках программы "Поставщик облачных решений" (CSP).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-589">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-590">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-590">Details</span></span>

<span data-ttu-id="8cf3f-591">1 апреля 2021 г. корпорация Майкрософт выпустит следующие новые продукты и предложения:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-591">On April 1, 2021, Microsoft will be launching the following new products and offers:</span></span>

- <span data-ttu-id="8cf3f-592">Power BI Premium на пользователя;</span><span class="sxs-lookup"><span data-stu-id="8cf3f-592">Power BI Premium Per User</span></span>
- <span data-ttu-id="8cf3f-593">расширение географии и сегментов для лицензий USL на Customer Voice и Marketing.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-593">Customer Voice and Marketing USL geo and segment expansion</span></span>

<span data-ttu-id="8cf3f-594">**Power BI Premium на пользователя**</span><span class="sxs-lookup"><span data-stu-id="8cf3f-594">**Power BI Premium Per User**</span></span>

<span data-ttu-id="8cf3f-595">Майкрософт представит первые предложения Power BI Premium на пользователя.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-595">Microsoft will introduce the first per-user Power BI Premium offers.</span></span> <span data-ttu-id="8cf3f-596">Сейчас Power BI Premium продается только в рамках модели на основе емкости.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-596">Power BI Premium is currently sold only in a capacity construct.</span></span> <span data-ttu-id="8cf3f-597">Power BI Premium на пользователя предоставляет доступ к возможностям корпоративной бизнес-аналитики и анализа.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-597">Power BI Premium Per User provides access to enterprise business intelligence (BI) and analytics capabilities.</span></span> <span data-ttu-id="8cf3f-598">Гибкие возможности лицензирования отдельных рабочих мест предназначены для малых и средних предприятий.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-598">Its flexible individual seat licensing caters to small and medium-sized businesses.</span></span>

<span data-ttu-id="8cf3f-599">Дополнительную информацию об этом предложении см. в [сведениях о выпуске Power BI](/power-platform-release-plan/2020wave2/power-bi/planned-features).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-599">Review the [Power BI release details](/power-platform-release-plan/2020wave2/power-bi/planned-features) to learn more about this offer.</span></span>


<span data-ttu-id="8cf3f-600">**Подробности предложения**</span><span class="sxs-lookup"><span data-stu-id="8cf3f-600">**Offer details**</span></span>

<span data-ttu-id="8cf3f-601">Обратите внимание, что название предложения немного отличается от названия предварительной версии, указанного в прейскуранте.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-601">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="8cf3f-602">Название предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-602">Offer name</span></span> | <span data-ttu-id="8cf3f-603">Идентификатор предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-603">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="8cf3f-604">Power BI Premium на пользователя</span><span class="sxs-lookup"><span data-stu-id="8cf3f-604">Power BI Premium Per User</span></span> | <span data-ttu-id="8cf3f-605">9c810018-9356-4903-95ab-eeb956289290</span><span class="sxs-lookup"><span data-stu-id="8cf3f-605">9c810018-9356-4903-95ab-eeb956289290</span></span> | 
| <span data-ttu-id="8cf3f-606">Power BI Premium на пользователя для преподавателей</span><span class="sxs-lookup"><span data-stu-id="8cf3f-606">Power BI Premium Per User for Faculty</span></span> | <span data-ttu-id="8cf3f-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span><span class="sxs-lookup"><span data-stu-id="8cf3f-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span></span> | 
| <span data-ttu-id="8cf3f-608">Power BI Premium на пользователя для учащихся</span><span class="sxs-lookup"><span data-stu-id="8cf3f-608">Power BI Premium Per User for Students</span></span> | <span data-ttu-id="8cf3f-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span><span class="sxs-lookup"><span data-stu-id="8cf3f-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span></span> | 
| <span data-ttu-id="8cf3f-610">Power BI Premium на пользователя (цены для сотрудников некоммерческих организаций)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-610">Power BI Premium Per User (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="8cf3f-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span><span class="sxs-lookup"><span data-stu-id="8cf3f-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span></span> | 
| <span data-ttu-id="8cf3f-612">Надстройка Power BI Premium на пользователя</span><span class="sxs-lookup"><span data-stu-id="8cf3f-612">Power BI Premium Per User Add-On</span></span> | <span data-ttu-id="8cf3f-613">244ff87e-5925-44a0-bf31-cea189719b58</span><span class="sxs-lookup"><span data-stu-id="8cf3f-613">244ff87e-5925-44a0-bf31-cea189719b58</span></span> | 
| <span data-ttu-id="8cf3f-614">Надстройка Power BI Premium на пользователя для преподавателей</span><span class="sxs-lookup"><span data-stu-id="8cf3f-614">Power BI Premium Per User Add-On for Faculty</span></span> | <span data-ttu-id="8cf3f-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span><span class="sxs-lookup"><span data-stu-id="8cf3f-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span></span> | 
| <span data-ttu-id="8cf3f-616">Надстройка Power BI Premium на пользователя для учащихся</span><span class="sxs-lookup"><span data-stu-id="8cf3f-616">Power BI Premium Per User Add-On for Students</span></span> | <span data-ttu-id="8cf3f-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span><span class="sxs-lookup"><span data-stu-id="8cf3f-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span></span> | 
| <span data-ttu-id="8cf3f-618">Надстройка Power BI Premium на пользователя (цены для сотрудников некоммерческих организаций)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-618">Power BI Premium Per User Add-On (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="8cf3f-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span><span class="sxs-lookup"><span data-stu-id="8cf3f-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span></span> | 

<span data-ttu-id="8cf3f-620">**Расширение географии и сегментов для лицензий USL на Customer Voice и Marketing**</span><span class="sxs-lookup"><span data-stu-id="8cf3f-620">**Customer Voice and Marketing USL geo and segment expansion**</span></span>

<span data-ttu-id="8cf3f-621">Вслед за выпуском в декабре 2020 года в предложения лицензий USL на Dynamics 365 Customer Voice и Marketing добавлены новые страны и дополнительные номера SKU для некоммерческих организаций и образовательных учреждений.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-621">As a follow-up to the December 2020 launch, Dynamics 365 Customer Voice and Marketing USL offers have been changed to add new countries and more nonprofit and educational SKUs.</span></span>

| <span data-ttu-id="8cf3f-622">Название предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-622">Offer name</span></span> | <span data-ttu-id="8cf3f-623">Идентификатор предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-623">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="8cf3f-624">USL на Dynamics 365 Customer Voice (цены для сотрудников некоммерческих организаций)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-624">Dynamics 365 Customer Voice USL (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="8cf3f-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span><span class="sxs-lookup"><span data-stu-id="8cf3f-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span></span> |
| <span data-ttu-id="8cf3f-626">USL на Dynamics 365 Customer Voice для преподавателей</span><span class="sxs-lookup"><span data-stu-id="8cf3f-626">Dynamics 365 Customer Voice USL for Faculty</span></span> | <span data-ttu-id="8cf3f-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span><span class="sxs-lookup"><span data-stu-id="8cf3f-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span></span> |

<span data-ttu-id="8cf3f-628">Чтобы узнать больше об этих предложениях, посетите следующие страницы:</span><span class="sxs-lookup"><span data-stu-id="8cf3f-628">Visit the following pages to find out more about these offers:</span></span>

- [<span data-ttu-id="8cf3f-629">Домашняя страница Dynamics 365 Customer Service Voice</span><span class="sxs-lookup"><span data-stu-id="8cf3f-629">Dynamics 365 Customer Service Voice home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)
- [<span data-ttu-id="8cf3f-630">Домашняя страница Dynamics 365 Marketing</span><span class="sxs-lookup"><span data-stu-id="8cf3f-630">Dynamics 365 Marketing home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)

### <a name="next-steps"></a><span data-ttu-id="8cf3f-631">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-631">Next steps</span></span>

<span data-ttu-id="8cf3f-632">Изучите доступные ресурсы на эту тему и поделитесь этой информацией с соответствующими заинтересованными лицами в своей организации.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-632">Review the resources on this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="8cf3f-633">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-633">Questions?</span></span>

<span data-ttu-id="8cf3f-634">С любыми вопросами по этим предложениям обращайтесь в соответствующее сообщество в Yammer.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-634">For any questions about these offers, check your relevant Yammer communities.</span></span> 

________________
## <a name="microsoft-universal-print-now-available-in-some-suites"></a><a name="1"></a> <span data-ttu-id="8cf3f-635">Теперь в некоторых наборах доступна Универсальная печать (Майкрософт)</span><span class="sxs-lookup"><span data-stu-id="8cf3f-635">Microsoft Universal Print now available in some suites</span></span>

### <a name="categories"></a><span data-ttu-id="8cf3f-636">Категории</span><span class="sxs-lookup"><span data-stu-id="8cf3f-636">Categories</span></span>

- <span data-ttu-id="8cf3f-637">Дата: 03.03.2021</span><span class="sxs-lookup"><span data-stu-id="8cf3f-637">Date: 2021-03-03</span></span>
- <span data-ttu-id="8cf3f-638">Характеристики</span><span class="sxs-lookup"><span data-stu-id="8cf3f-638">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="8cf3f-639">Сводка</span><span class="sxs-lookup"><span data-stu-id="8cf3f-639">Summary</span></span>

<span data-ttu-id="8cf3f-640">C 1 марта 2021 г. Универсальная печать (Майкрософт) будет доступна для сделок в составе некоторых пакетов Microsoft 365 и в виде отдельной надстройки.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-640">Microsoft Universal Print will be available to transact within select Microsoft 365 suites and as a standalone add-on from March 1, 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8cf3f-641">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="8cf3f-641">Impacted audience</span></span>

<span data-ttu-id="8cf3f-642">Все партнеры, заключающие сделки в рамках программы "Поставщик облачных решений" (CSP).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-642">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="8cf3f-643">Сведения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-643">Details</span></span>

<span data-ttu-id="8cf3f-644">[Универсальная печать](https://aka.ms/universalprint) — это служба печати Microsoft 365, которая устраняет необходимость в использовании локальных серверов печати и позволяет устройствам Windows печатать на принтерах, зарегистрированных в Azure.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-644">[Universal Print](https://aka.ms/universalprint) is a Microsoft 365 print service that removes the need for on-premises print servers, and enables Windows devices to print to Azure-registered printers.</span></span> <span data-ttu-id="8cf3f-645">Она станет доступна для сделок 1 марта 2021 г.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-645">It will be available to transact from March 1, 2021.</span></span>

<span data-ttu-id="8cf3f-646">Сотрудники оценят преимущества в виде печати без драйверов, упрощенного обнаружения принтеров на основе расположения и интуитивно понятный интерфейс печати, для работы с которым не требуется обучение.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-646">Workers benefit from driverless printing, streamlined location-based printer discovery, and an intuitive printing experience with no learning curve.</span></span> <span data-ttu-id="8cf3f-647">Устройства, подключенные к Azure Active Directory (Azure AD), используют для безопасной печати существующие учетные данные Azure AD.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-647">Devices that are joined to Azure Active Directory (Azure AD) use existing Azure AD credentials to print securely.</span></span> <span data-ttu-id="8cf3f-648">Администраторы управляют печатью с помощью портала Azure и могут легко подключаться к принтерам с нативной поддержкой Универсальной печати.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-648">Administrators manage printing by using the Azure portal, and can easily connect printers with native support for Universal Print.</span></span> <span data-ttu-id="8cf3f-649">Универсальную печать можно развернуть на несовместимых принтерах с помощью коннектора универсальной печати.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-649">Universal Print can be deployed with non-compatible printers by using Universal Print connector software.</span></span>

<span data-ttu-id="8cf3f-650">После выпуска Универсальная печать будет добавлена в Windows E3, A3, E5 и A5, а также Microsoft 365 BP, F3, E3, A3, E5 и A5.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-650">Universal Print will be backfilled at launch to Windows E3, A3, E5, and A5, and Microsoft 365 BP, F3, E3, A3, E5, and A5.</span></span>  

<span data-ttu-id="8cf3f-651">**Подробности предложения**</span><span class="sxs-lookup"><span data-stu-id="8cf3f-651">**Offer details**</span></span>

<span data-ttu-id="8cf3f-652">Обратите внимание, что название предложения немного отличается от названия предварительной версии, указанного в прейскуранте.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-652">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="8cf3f-653">Название предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-653">Offer name</span></span> | <span data-ttu-id="8cf3f-654">Идентификатор предложения</span><span class="sxs-lookup"><span data-stu-id="8cf3f-654">Offer ID</span></span> | <span data-ttu-id="8cf3f-655">Идентификатор материалов</span><span class="sxs-lookup"><span data-stu-id="8cf3f-655">Material ID</span></span> |
| ------ |----------- |----------- |  
| <span data-ttu-id="8cf3f-656">Надстройка объема Универсальной печати (500 заданий) — Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="8cf3f-656">Universal Print volume add-on (500 jobs) - Microsoft 365</span></span>  | <span data-ttu-id="8cf3f-657">cb131356-45ee-4ae2-8537-873b706c8e75</span><span class="sxs-lookup"><span data-stu-id="8cf3f-657">cb131356-45ee-4ae2-8537-873b706c8e75</span></span>     | <span data-ttu-id="8cf3f-658">9BI-00004</span><span class="sxs-lookup"><span data-stu-id="8cf3f-658">9BI-00004</span></span>   |
| <span data-ttu-id="8cf3f-659">Надстройка объема Универсальной печати (500 заданий) для преподавателей — Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="8cf3f-659">Universal Print volume add-on (500 jobs) for faculty - Microsoft 365</span></span>   | <span data-ttu-id="8cf3f-660">477bee81-9872-43d6-91d3-c72390bfcf49</span><span class="sxs-lookup"><span data-stu-id="8cf3f-660">477bee81-9872-43d6-91d3-c72390bfcf49</span></span>   | <span data-ttu-id="8cf3f-661">9BK-00004</span><span class="sxs-lookup"><span data-stu-id="8cf3f-661">9BK-00004</span></span>   |
| <span data-ttu-id="8cf3f-662">Надстройка объема Универсальной печати (500 заданий) — Windows</span><span class="sxs-lookup"><span data-stu-id="8cf3f-662">Universal Print volume add-on (500 jobs) - Windows</span></span>    | <span data-ttu-id="8cf3f-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span><span class="sxs-lookup"><span data-stu-id="8cf3f-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span></span>   | <span data-ttu-id="8cf3f-664">9BI-00002</span><span class="sxs-lookup"><span data-stu-id="8cf3f-664">9BI-00002</span></span>   |
| <span data-ttu-id="8cf3f-665">Надстройка объема Универсальной печати (500 заданий) для преподавателей — Windows</span><span class="sxs-lookup"><span data-stu-id="8cf3f-665">Universal Print volume add-on (500 jobs) for faculty - Windows</span></span>   |  <span data-ttu-id="8cf3f-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span><span class="sxs-lookup"><span data-stu-id="8cf3f-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span></span>  | <span data-ttu-id="8cf3f-667">9BK-00002</span><span class="sxs-lookup"><span data-stu-id="8cf3f-667">9BK-00002</span></span>   |

### <a name="next-steps"></a><span data-ttu-id="8cf3f-668">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="8cf3f-668">Next steps</span></span>

<span data-ttu-id="8cf3f-669">Ознакомьтесь с прейскурантом и [обзором Универсальной печати](/universal-print/fundamentals/universal-print-whatis).</span><span class="sxs-lookup"><span data-stu-id="8cf3f-669">Familiarize yourself with the price list and the [Universal Print overview](/universal-print/fundamentals/universal-print-whatis).</span></span> <span data-ttu-id="8cf3f-670">Передайте эти сведения всем соответствующим лицам в своей организации.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-670">Share this information with all appropriate contacts in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="8cf3f-671">Есть вопросы?</span><span class="sxs-lookup"><span data-stu-id="8cf3f-671">Questions?</span></span>

<span data-ttu-id="8cf3f-672">С любыми вопросами по этим предложениям обращайтесь в соответствующее сообщество в Yammer.</span><span class="sxs-lookup"><span data-stu-id="8cf3f-672">For any questions about these offers, check your relevant Yammer communities.</span></span>