...
### <a name="impacted-audience"></a><span data-ttu-id="0a6e0-109">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="0a6e0-109">Impacted audience</span></span>
...
### <a name="questions"></a><span data-ttu-id="0a6e0-120">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="0a6e0-120">Questions?</span></span>
...
<span data-ttu-id="0a6e0-132">Партнеры по совместным продажам теперь могут экспортировать и импортировать возможные сделки в большом масштабе благодаря новой функции массовых операций с использованием CSV-файла в Центре партнеров.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-132">Co-selling partners can now export and import opportunities at scale using the new Partner Center CSV file bulk operations feature.</span></span>
...
### <a name="categories"></a><span data-ttu-id="0a6e0-143">Категории</span><span class="sxs-lookup"><span data-stu-id="0a6e0-143">Categories</span></span>
...
### <a name="questions"></a><span data-ttu-id="0a6e0-155">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="0a6e0-155">Questions?</span></span>
...
<span data-ttu-id="0a6e0-169">Обратите внимание, что сделки совместной продажи под руководством партнера можно преобразовать в активную совместную продажу в любой момент до закрытия сделки.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-169">Note that partner-led co-sell deals can be upgraded to active co-sell at any point prior to deal closure.</span></span>
...
### <a name="summary"></a><span data-ttu-id="0a6e0-181">Итоги</span><span class="sxs-lookup"><span data-stu-id="0a6e0-181">Summary</span></span>
...
<span data-ttu-id="0a6e0-202">Партнерам, которые соответствуют критериям, нужно будет сообщить нам **юридический идентификатор** клиента (также называемый **ИНН организации** клиента) и его **номер телефона** при регистрации новых клиентов или изменении сведений для существующих клиентов.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-202">Partners who meet the criteria will have to submit a customer's **legal identifier** (also known as the customer's **organization INN**) and **phone number** when they are onboarding new customers or modifying existing customer details.</span></span> <span data-ttu-id="0a6e0-203">Такие партнеры теперь также могут при желании указать **отчество** клиента.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-203">These partners can also enter an optional **middle name** for the customer.</span></span>
...
- <span data-ttu-id="0a6e0-222">Если вы используете решение поставщика панели управления (CPV), обратитесь к нему за консультацией.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-222">If you’re using a control panel vendor (CPV) solution, consult your CPV.</span></span>
...
<span data-ttu-id="0a6e0-234">Существующие прямые и косвенные партнеры в рамках программы "Поставщик облачных решений" (CSP), заключившие MPA.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-234">Existing direct and indirect Cloud Solution Provider (CSP) partners under MPA.</span></span>
...
- <span data-ttu-id="0a6e0-260">15 января 2021 г. — дата исходной публикации.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-260">January 15, 2021: original publication</span></span> 
...
<span data-ttu-id="0a6e0-274">**Преимущества для партнеров.**</span><span class="sxs-lookup"><span data-stu-id="0a6e0-274">**Partner benefits:**</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="0a6e0-354">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="0a6e0-354">Next steps</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="0a6e0-369">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="0a6e0-369">Next steps</span></span>
...
|<span data-ttu-id="0a6e0-382">**Название предложения**</span><span class="sxs-lookup"><span data-stu-id="0a6e0-382">**Offer name**</span></span>|<span data-ttu-id="0a6e0-383">**Идентификатор предложения**</span><span class="sxs-lookup"><span data-stu-id="0a6e0-383">**Offer ID**</span></span>|<span data-ttu-id="0a6e0-384">**Идентификатор материалов**</span><span class="sxs-lookup"><span data-stu-id="0a6e0-384">**Material ID**</span></span>|
|------------------|:--------------------|:------------------|
...
### <a name="details"></a><span data-ttu-id="0a6e0-407">Сведения</span><span class="sxs-lookup"><span data-stu-id="0a6e0-407">Details</span></span>
...
<span data-ttu-id="0a6e0-422">Новые возможности в модуле клиентов по рекомендации в Центре партнеров:</span><span class="sxs-lookup"><span data-stu-id="0a6e0-422">Here’s what’s new in the Partner Center Referrals module:</span></span>
...
- <span data-ttu-id="0a6e0-431">[Использование автоматической регистрации сделки.](../register-deals.md) Сэкономьте время и обеспечьте точность, зарегистрировав предложения Azure, которые могут быть предметом сделки, размещенные на коммерческой платформе Майкрософт, с помощью флажка This deal/win has been or will be transacted through Azure Marketplace or AppSource (Эта потенциальная или заключенная сделка будет проведена посредством Azure Marketplace или AppSource).</span><span class="sxs-lookup"><span data-stu-id="0a6e0-431">[Use auto deal registration](../register-deals.md): Save time and ensure accuracy by registering transactable Microsoft Commercial Marketplace Azure offers using the check box, “This deal/win has been or will be transacted through Azure Marketplace or AppSource.”</span></span> <span data-ttu-id="0a6e0-432">Если дата сделки верна, информация для регистрации сделки будет извлекаться непосредственно из коммерческой платформы Майкрософт.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-432">So long as your transaction date is correct, the information for deal registration will be pulled directly from the Microsoft commercial marketplace.</span></span>

### <a name="questions"></a><span data-ttu-id="0a6e0-433">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="0a6e0-433">Questions?</span></span>

<span data-ttu-id="0a6e0-434">Если вам нужна помощь с использованием каких-либо новых функций, ознакомьтесь с [разделом о клиентах по рекомендации](../referrals.md) в нашей базе знаний или в практических материалах по поддержке, доступных в [этой коллекции ресурсов по совместной продаже](https://aka.ms/CoSellExperience) (нужно выполнить вход).</span><span class="sxs-lookup"><span data-stu-id="0a6e0-434">If you need help with using any of the new features, check out the [Referrals section](../referrals.md) in our knowledge base or our how-to support materials available in our [Co-sell experience gallery](https://aka.ms/CoSellExperience) (sign-in required).</span></span>

<span data-ttu-id="0a6e0-435">Чтобы получить помощь, вы можете [отправить запрос в службу поддержки партнеров](https://partner.microsoft.com/support/?stage=1).</span><span class="sxs-lookup"><span data-stu-id="0a6e0-435">You can [open a ticket with our Partner Support team](https://partner.microsoft.com/support/?stage=1) for support.</span></span>

________________
## <a name="deprecation-and-retirement-of-put-qualification-apis-for-the-education-customer-validation-process-by-february-25-2021-and-get-qualification-by-may-4-2021"></a><a name="1"></a> <span data-ttu-id="0a6e0-436">Объявление нерекомендуемыми и прекращение поддержки API-интерфейсов квалификации PUT для проверки соответствия требованиям клиентов из сферы образования до 25 февраля 2021 г. и квалификации GET до 4 мая 2021 г.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-436">Deprecation and retirement of PUT Qualification APIs for the Education customer validation process by February 25, 2021 and GET qualification by May 4, 2021.</span></span>

### <a name="categories"></a><span data-ttu-id="0a6e0-437">Категории</span><span class="sxs-lookup"><span data-stu-id="0a6e0-437">Categories</span></span>

- <span data-ttu-id="0a6e0-438">Дата: 4 февраля 2021 г.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-438">Date: February 4, 2021</span></span>
- <span data-ttu-id="0a6e0-439">Характеристики</span><span class="sxs-lookup"><span data-stu-id="0a6e0-439">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="0a6e0-440">Затронутая аудитория</span><span class="sxs-lookup"><span data-stu-id="0a6e0-440">Impacted audience</span></span>

<span data-ttu-id="0a6e0-441">Партнеры, продающие предложения для образовательных учреждений, некоммерческих организаций и предложения GCC в рамках программы "Поставщик облачных решений" и использующие API Центра партнеров.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-441">Partners selling Academic, Non-Profit, and GCC offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="0a6e0-442">Сведения</span><span class="sxs-lookup"><span data-stu-id="0a6e0-442">Details</span></span>

<span data-ttu-id="0a6e0-443">Это объявление дополняет сведения об [усовершенствованиях в Центре партнеров, выпущенных в декабре](./2020-december.md#1).</span><span class="sxs-lookup"><span data-stu-id="0a6e0-443">This announcement is a follow-up to the Partner Center [enhancements released in December](./2020-december.md#1).</span></span> <span data-ttu-id="0a6e0-444">В рамках этого выпуска были развернуты новые API-интерфейсы квалификаций GET и POST. Как следствие, **поддержка существующих API-интерфейсов квалификаций PUT Центра партнеров будет прекращена до 25 февраля 2021, а GET — до 4 мая 2021 г.**</span><span class="sxs-lookup"><span data-stu-id="0a6e0-444">As part of that release, new GET and POST Qualifications APIs were deployed, and as a result **the existing PUT Qualification APIs Partner Center APIs will retire by February 25, 2021 and GET qualification by May 4, 2021**.</span></span> <span data-ttu-id="0a6e0-445">К этому времени нужно будет перейти на новые API-интерфейсы POST Центра партнеров, чтобы приобрести предложения для образовательных учреждений, и новый API квалификаций GET для приобретения предложений для некоммерческих организаций и предложений GCC с предварительными квалификациями.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-445">At that time, you will need to have transitioned to using the new POST Partner Center APIs in order to be able to purchase Education offers and the new GET qualifications API to purchase pre-qualified Non-profit and GCC offers.</span></span>

### <a name="next-steps"></a><span data-ttu-id="0a6e0-446">Дальнейшие действия</span><span class="sxs-lookup"><span data-stu-id="0a6e0-446">Next steps</span></span>

- <span data-ttu-id="0a6e0-447">**Выполните обновление до новых API** для успешного и своевременного перехода.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-447">**Update to the new APIs** for a successful and timely transition</span></span>
- <span data-ttu-id="0a6e0-448">**Ознакомьтесь со сведениями об изменениях API-интерфейсов в Центре партнеров и руководстве** в ресурсах по подготовке к работе: [Улучшения процесса проверки клиентов в Центре партнеров.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="0a6e0-448">**Review the new Partner Center API changes and Guide** in the Operations Readiness resources: [Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span></span>
- <span data-ttu-id="0a6e0-449">**Передайте эти сведения соответствующим командам** в своей организации и торговым посредникам, чтобы помочь им подготовиться к изменениям.</span><span class="sxs-lookup"><span data-stu-id="0a6e0-449">**Share this information with the appropriate teams** within your organization, and with your resellers, to help them prepare for these changes.</span></span>

### <a name="questions"></a><span data-ttu-id="0a6e0-450">У вас появились вопросы?</span><span class="sxs-lookup"><span data-stu-id="0a6e0-450">Questions?</span></span>

<span data-ttu-id="0a6e0-451">Любые вопросы, связанные с этим уведомлением, можно задать [службе поддержки Центра партнеров](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals).</span><span class="sxs-lookup"><span data-stu-id="0a6e0-451">For any questions related to this notification contact [Partner Center support](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals).</span></span>

### <a name="change-log"></a><span data-ttu-id="0a6e0-452">Журнал изменений</span><span class="sxs-lookup"><span data-stu-id="0a6e0-452">Change log</span></span>

- <span data-ttu-id="0a6e0-453">Февраль. Обновлены сроки объявления квалификаций GET и PUT нерекомендуемыми</span><span class="sxs-lookup"><span data-stu-id="0a6e0-453">February: Updated timelines for deprecation of GET & PUT qualifications</span></span>
- <span data-ttu-id="0a6e0-454">Январь. Напоминание о предстоящем объявлении квалификаций GET и PUT нерекомендуемыми</span><span class="sxs-lookup"><span data-stu-id="0a6e0-454">January: Reminder of upcoming deprecations of GET & PUT qualifications</span></span>