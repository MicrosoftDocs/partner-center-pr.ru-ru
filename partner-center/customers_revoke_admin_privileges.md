...
|**Действие**   |**Прямое выставления счета партнера, так и косвенным поставщиком**   |**Косвенный торговый посредник**   |
|-----------------|-----------------------------------| -----------------------------|
...
>**Важно!** Чтобы изменить может продолжить текущие возможности интерфейса управления Autopilot на информационной панели. На момент публикации этой статьи рассматриваются следующие изменения:
...
- Партнер должен предоставить делегированные права администратора клиента перед партнер сможет удалять устройства, добавлены другими партнерами или самим пользователем в клиент пользователя. В противном случае партнер сможет удалять только те устройства, добавленного ранее тем же партнером.
