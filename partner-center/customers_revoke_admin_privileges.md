...
> [!IMPORTANT]  
> Чтобы изменить может продолжить текущие возможности интерфейса управления Autopilot в центре партнеров. На момент публикации этой статьи рассматриваются следующие изменения:
