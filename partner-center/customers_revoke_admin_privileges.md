...
6.  Чтобы управлять учетной записи клиента, служб, пользователи и лицензии, разверните запись клиента, нажав стрелку вниз рядом с его именем, а затем выберите на портале администратора службы, которую вы хотите управлять.
...
1. Пользователь должен войти на портал администрирования Office 365 в качестве глобального администратора.
...
В центре партнеров партнеры CSP могут управлять профилями Autopilot для своих клиентов без делегированные права администратора. Узнайте, как [упростить настройку устройств с помощью Windows Autopilot.](https://docs.microsoft.com/partner-center/autopilot)
...
- Невозможно управлять устройствами, которые клиент добавлена через магазин Майкрософт для бизнеса, магазин Майкрософт для образования или портала Microsoft Intune.

> [!IMPORTANT]  
> Текущие возможности интерфейса управления Autopilot в центре партнеров может по-прежнему изменения. На момент публикации этой статьи рассматриваются следующие изменения:
...
- Должен предоставить делегированные права администратора от клиента перед партнер сможет удалять устройства, добавлены другими партнерами или самим пользователем в клиент пользователя. В противном случае партнер сможет удалять только устройства, добавленного ранее тем же партнером.
