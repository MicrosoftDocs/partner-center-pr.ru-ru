...
- [<span data-ttu-id="b0bdb-112">Справочник развертывания AutoPilot</span><span class="sxs-lookup"><span data-stu-id="b0bdb-112">Autopilot deployment reference guide</span></span>](https://assetsprod.microsoft.com/autopilot-deployment-program-reference-guide-csp.docx)  
