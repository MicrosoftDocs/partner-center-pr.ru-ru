...
>[!IMPORTANT]
>Хотя у вас не должны быть глобальным администратором в вашей организации, чтобы приобрести преимущества, должны быть глобальный администратор назначение преимуществами для сотрудников.  Если вы хотите, вы станете глобальный администратор, следуя инструкциям на [странице **преимущества** ](https://partnercenter.microsoft.com/pcv/partnership/benefits) (вход). Кроме того вашей организации уже может быть глобальный администратор поэтому обязательно проверьте со своей командой.
