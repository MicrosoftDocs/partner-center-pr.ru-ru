...
>[!IMPORTANT]
>В этой статье объясняется, как начать использовать ваш Microsoft Partner Network (MPN) членства преимущества в партнерском центре (ранее известная как центра партнеров) — для этого сайта. Если вы еще не получили приглашение для перемещения из центра партнеров членства (PMC) сведений о компании для центра партнеров, следует продолжать управлять свои преимущества членства MPN в PMC. [Войти в](https://partner.microsoft.com/_login?authType=OpenIdConnect) PMC.   
