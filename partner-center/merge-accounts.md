...
- Связь DPOR или PAL не влияет. Все связанные вклады доходов начнут передаваться в глобальную учетную запись партнера
...
- [Назначение ролей пользователей и разрешений](permissions-overview.md)
