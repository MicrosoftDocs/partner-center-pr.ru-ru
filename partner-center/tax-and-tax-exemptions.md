...
1.  Найдите свой **Идентификатор Майкрософт** в центре партнеров &gt; **Параметры учетной записи** &gt; **профиль организации**.
2.  Найдите свой **Идентификатор MPN** в центре партнеров &gt; **Параметры учетной записи** &gt; **профиль партнера**.
3.  Создайте новый запрос в службу поддержки. В меню центра партнеров выберите **запросы на обслуживание** &gt; **запросы центра партнеров** &gt; **новый запрос**.
...
<ol>
<li>В центре партнеров перейдите в меню центра партнеров &gt; <strong>Параметры учетной записи</strong> &gt; <strong>профиль выставления счетов партнера</strong>.</li>
