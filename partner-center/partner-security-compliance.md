...
Метрики вычисляются ежедневно с учетом операций, выполненных за последние 7 дней. Если вы только недавно завершили реализацию MFA для арендатора партнера, то метрики могут не показывать 100 %.
