...
В отчете о MFA в Центре партнеров представлены полезные сведения о реализации MFA у партнеров. Отчет содержит два типа метрик на основе конфигурации MFA и действий клиента CSP в Центре партнеров. 
