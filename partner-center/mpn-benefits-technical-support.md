...
Шаг 1. Выбор Windows 10 и ввод фиктивной информации

Шаг 2. Добавление контракта на поддержку с использованием идентификатора доступа и идентификатора контракта. Для локальной поддержки можно увидеть, как отображается контракт на поддержку партнеров, а также дату начала, дату окончания и количество инцидентов. Разверните узел "вы хотите просмотреть недоступные планы поддержки?". (сведения о сигнатуре партнера см. в разделе). Здесь отображается только поддержка партнеров, если срок действия контрактов истек, не осталось инцидентов или был выбран Старый локальный продукт (см. раздел [AKA.MS/n-1](https://aka.ms/n-1) for support Products).
