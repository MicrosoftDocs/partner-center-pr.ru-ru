...
-   Войдите в **Информационную панель** с **Переходной** (существующей) учетной записью (с той, с которой вы перейдете на основную) и запишите всех клиентов и все службы, настроенные для них.
...
1.  Войдите в **Информационную панель** с **Переходной** (новой) учетной записью (с той, на которую вы осуществляете переход) и перейдите к списку пользователей в разделе **Клиенты**.
...
2.  В меню **Информационная панель** выберите пункт **Клиенты**.
...
1.  Войдите в **Информационную панель** с **Переходной** учетной записью CSP и перейдите в список клиентов.
