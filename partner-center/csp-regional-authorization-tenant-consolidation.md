...
# Консолидация клиента региональной авторизации CSP
...
## Миграция учетных записей клиентов
...
## Перенос подписок Office 365 и не связанных с Azure подписок с учетом использования
...
## Отключение подписок Office 365 в переносимой партнерской учетной записи
...
## Миграция Azure подписки с учетом использования
...
### Упрощение миграции с помощью экспорта
...
## Журнал действий Центра партнеров
