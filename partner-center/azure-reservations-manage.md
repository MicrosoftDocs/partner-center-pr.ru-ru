...
В этой статье объясняется, как управлять резервированием Azure для клиента, включая способы отмены резервирования, обмена резервированиями или запроса на возврат денег.
