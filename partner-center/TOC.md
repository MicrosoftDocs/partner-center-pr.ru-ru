...
# [Участие в Partner Network](mpn-overview.md)
...
### [Программа Software Assurance Training Voucher (SATV) в Центре партнеров](software-assurance-satv.md)
...
## [Соглашения об использовании Microsoft Cloud по регионам и языкам](agreements.md)
...
## [Расположение](manage-locations.md)
...
## [Проверка владения доменом](become-global-admin.md)
...
## [Вопросы и ответы о выставлении счетов](faq-about-new-billing-features.md)
...
### [Продажа подписок Minecraft. Подписки Education Edition](minecraft-subscriptions.md)
...
### [Переход подписок Dynamics AX до версии Dynamics 365](manual-subscription-migration.md)
...
### [Перенос Skype для бизнеса Online План 1 в новые версии Office 365](skype-retiring.md)
...
## [Получение данных об использовании клиентских подписок Azure](analyze-azure-usage.md)
