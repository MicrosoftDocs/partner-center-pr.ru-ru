...
## [Управление расположениями компании](manage-locations.md)
...
### [Аналитика Центра партнеров — обзорная панель мониторинга](pci-overview-report.md)
### [Аналитика Центра партнеров — панель мониторинга для клиентов](pci-customer-report.md)
### [Аналитика Центра партнеров — панель мониторинга для подписок на продукты](pci-product-subscriptions-report.md)
### [Аналитика Центра партнеров — панель мониторинга для лицензий на продукты](pci-product-licenses-report.md)
### [Аналитика Центра партнеров — панель мониторинга для данных об использовании Azure](pci-azure-usage-report.md)
...
### [Аналитика Центра партнеров — известные проблемы](pci-known-issues.md)
