...
### [Управление резервированиями Microsoft Azure от лица клиентов | Центр партнеров](azure-reservations-manage.md)
### [Выставление счетов за резервирования Azure](azure-reservations-billing.md)
## [Подписки](customer-subscriptions.md)
...
## [Задачи торгового посредника в информационной панели Центра партнеров](indirect-reseller-tasks-in-partner-center.md)
