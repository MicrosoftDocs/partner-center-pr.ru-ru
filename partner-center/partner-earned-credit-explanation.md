...
- Сведения о PEC также доступны на странице [службы "Управление затратами Azure"](https://docs.microsoft.com/azure/cost-management-billing/costs/get-started-partners).
