...
description: "Привлекайте больше потенциальных клиентов, создав бизнес-профиль в Центре партнеров."
...
**Вниманию пользователей инструментов Pinpoint, C2PC и Sales Connect!** Мы объединяем эти средства в Центре партнеров. Если вы использовали эти средства ранее, создайте новый бизнес-профиль в Центре партнеров, чтобы продолжить формировать потенциальных клиентов и управлять ими. Обратите внимание, что в настоящее время импорт профилей с предыдущих версий веб-сайтов не поддерживается. 
