...
1.  В меню **Центра партнеров** , выберите **ссылки** &gt; **бизнес-профили** &gt; выберите страну или регион > **[Создание бизнес-профиль](https://partnercenter.microsoft.com/pcv/publishing)**.

2.  На странице **Создание бизнес-профиля** выберите регион, а затем введите данные профиля.
    > [!NOTE]  
    >  В центре партнеров поддерживает несколько языков, некоторые элементы, такие как описание и теги произвольной формы, может потребоваться добавить текст на разных языках, как указано в этом разделе.
