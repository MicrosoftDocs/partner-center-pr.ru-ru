...
> [!NOTE]  
>  Перед созданием бизнес-профиль, вам потребуется учетная запись информационной панели центра партнеров. Если у вас еще нет учетной записи информационной панели Центра партнеров, см. раздел [Создание учетной записи информационной панели Центра партнеров](mpn-create-a-partner-center-account.md). 
...
2.  На странице **Создание бизнес-профиля** выберите регион, а затем введите данные профиля.
    > [!NOTE]  
    >  Информационная панель центра партнеров поддерживает несколько языков, некоторые элементы, такие как описание и теги произвольной формы, может потребоваться добавить текст на разных языках, как указано в этом разделе.
