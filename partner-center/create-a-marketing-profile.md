...
>**Примечание.** Перед созданием бизнес-профиля необходимо создать учетную запись центра партнеров. Если у вас еще нет учетной записи Центра партнеров, см. раздел [Создание учетной записи Центра партнеров](mpn-create-a-partner-center-account.md). 
...
2.  На **Информационной панели** выберите **Рекомендации** &gt; **Просмотреть бизнес-профили** &gt; выберите страну/регион > **[Создать бизнес-профиль](https://partnercenter.microsoft.com/pcv/publishing)**.

3.  На странице **Создание бизнес-профиля** выберите регион, а затем введите данные профиля.
