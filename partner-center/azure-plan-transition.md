...
В этой статье объясняется, как партнеры в рамках CSP могут с помощью Центра партнеров переводить клиентов с существующих предложений Azure CSP на службы Azure в рамках плана Azure. Косвенные поставщики и партнеры с правом на прямое выставление счетов могут перейти на новую коммерческую модель, доступную в программе для поставщиков облачных решений (CSP) от Майкрософт для Azure. (Косвенные торговые посредники должны обращаться к своим косвенным поставщикам.) Клиентам будет проще покупать облачные службы у партнеров, торговых посредников Майкрософт или непосредственно в Интернете.

Возможность перехода предназначена только для клиентов, которые переходят на новую коммерческую модель для Azure и подписали Клиентское соглашение Майкрософт, а не для других предложений в CSP, таких как Office 365 или Dynamics 365.
...
3. Выберите **Продолжить**.
   ...
   **Рабочий процесс перехода автоматизирует необходимые шаги**:
   ...
   Например, партнер приобрел два предложения Microsoft Azure и включил в покупку два отдельных заказа на поставку. В этом случае в рамках рабочего процесса перехода будут приобретены два плана Azure (по одному на торгового посредника), а подписки Azure будут автоматически сопоставлены с этими планами Azure.  
