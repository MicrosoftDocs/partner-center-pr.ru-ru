...
После приобретения программного обеспечения клиенты должны скачать его. Выполните следующие действия.
...
2. Скопируйте "глубокую ссылку" в **раздел "ссылка на программный ключ продукта" и "загрузки** " и Поделитесь ссылкой с вашим клиентом. При выборе этой ссылки они будут перенаправлены в центр администрирования Майкрософт, чтобы скачать и получить ключи продуктов.

>[!NOTE]
>Ключи продуктов и сведения о загрузке можно просмотреть только у клиентов в центре администрирования Майкрософт. Партнеры не видят эту информацию.
