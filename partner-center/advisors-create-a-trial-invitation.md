...
---
# <a name="advisors-create-a-trial-invitation"></a>Помощники: создание приглашения для пробной версии
...
1. Перейдите к **пробным и приобретенным предложениям** > **создания приглашений**.
