...
> [!NOTE]  
> Ваш счет-фактура представляет собой совокупность всех платежей — программы, продукты и пользователям — за текущий период выставления счетов и доступно в течение двух (2) дней после выбранной даты выставления счетов в формате UTC. Например при наличии 12 сентября датой выставления счетов, процесс создания накладной будет начинаются с 12:00:00 UTC на 13-й и выполнить с 12:00:00 UTC на 14. Если вы не видите вашего счета-фактуры по UTC: 59: 00 на 15, находятся за пределами вашей соглашение об уровне обслуживания, а следует файл запроса в службу поддержки. 
