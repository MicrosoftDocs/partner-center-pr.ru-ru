...
- **Убедитесь, что предложения доступны в прайс-листе.** Список доступных предложений может изменяться каждый месяц. Если вы не можете найти предложение в каталоге, убедитесь, что оно указано в текущих прейскурантах на странице **Продажа > Цены и предложения**.
...
- [Как продавать предложения клиентам из сферы образования и создавать такого клиента](https://docs.microsoft.com/partner-center/sell-to-education-customers)
- [Продажи представителям определенных отраслей, например образовательным, некоммерческим и государственным организациям](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers)
