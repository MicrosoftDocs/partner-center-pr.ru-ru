...
1. Из значок « **Параметры** » в верхней правой части центра партнеров выберите **Управление пользователями**.
...
>[!Important]
>Пользователям необходимо назначить хотя бы одну роль для работы в центре партнеров.
