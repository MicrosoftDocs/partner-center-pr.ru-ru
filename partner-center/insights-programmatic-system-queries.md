...
---
# <a name="list-of-system-queries-for-partner-insights-programmatic-access"></a>Список системных запросов для программного доступа Partner Insights

Следующие системные запросы можно использовать в [API Create Report](insights-programmatic-access-paradigm.md#create-report-api) напрямую с QueryId. Системные запросы подобны отчетам об экспорте в центре партнеров в течение шести месяцев (6 мин) вычислительного периода.

Дополнительные сведения о именах, атрибутах и описании столбцов см. в [определениях данных](insights-data-definitions.md) .

В следующих разделах представлены запросы для создания различных отчетов.

## <a name="customers"></a>Клиенты

Отчет о клиентах за последние шесть месяцев

Идентификатор запроса: `6664daf3-c161-423a-92a1-0ea6db2c0384`

### <a name="report-query"></a>Запрос отчета
```sql
...
## <a name="seats-subscriptions-and-revenue"></a>Подписки на рабочие места и доходы

Рабочие места, подписки и отчет о доходах за последние шесть месяцев

Идентификатор запроса: `c9fc1c79-4408-49ff-97f9-e1aa3f155804`
...
Идентификатор запроса: `e65f3a4f-fb99-4319-97ff-59e57566a871`
...
Отчет AzureUsage за последние шесть месяцев

Идентификатор запроса: `d1a4d75e-5ca8-4847-845f-ee0a9be6f07b`
...
## <a name="office-usage"></a>Office Загрузка

Отчет Оффицеусаже за последние шесть месяцев

Идентификатор запроса: `d8349f7b-a7d1-467e-b26d-434d4a50f26a`
...
## <a name="dynamics-usage"></a>Использование Dynamics

Отчет Динамиксусаже за шесть месяцев

Идентификатор запроса: `6209a8fd-93af-442e-8b3f-3df0f77e8463`
...
## <a name="power-bi-usage"></a>Использование Power BI

Отчет Повербиусаже за шесть месяцев

Идентификатор запроса: `40ebfe2f-7183-4427-a911-5c9b45b6df15`
...
## <a name="ems-usage"></a>Использование EMS

Отчет Емсусаже за шесть месяцев

Идентификатор запроса: `d7f20ea4-8751-4d6b-b1d7-821c316acd6a`
...
## <a name="competency-performance-requirement-report"></a>Отчет о требованиях к производительности компетенции

Отчет Компетенципеформанцерекуиремент за шесть месяцев

Идентификатор запроса: `3a0e1adc-f5c1-42ac-9422-8e944bf81ae5`
...
## <a name="cloud-products-reseller-performance"></a>Производительность торгового посредника для облачных продуктов

### <a name="report-description"></a>Описание отчета

Отчет Клаудпродуктсреселлерперформанце за шесть месяцев

Идентификатор запроса: `c09c2eda-861b-4664-8ee8-48a14745a26a`
...
## <a name="clas-agreement-renewal-propensity"></a>КЛАСное выручкой продление соглашения

Отчет Класагриментреневалспропенсити за шесть месяцев

Идентификатор запроса: `c4fc87ac-4cca-44cd-bf4d-835ac513f9ee`
...
## <a name="clas-azure-propensity"></a>КЛАСие выручки Azure

Отчет Класазурепропенсити за шесть месяцев

Идентификатор запроса: `9a18bd70-8f90-4bd2-8266-5f6e453e3ee7`
...
## <a name="clas-d365-propensity"></a>Клас D365

Отчет CLASD365Propensity за шесть месяцев

Идентификатор запроса: `258fdcac-6e9c-4072-af27-b1b3d97be16c`
...
## <a name="clas-m365-propensity"></a>Клас M365

Отчет CLASM365Propensity за шесть месяцев

Идентификатор запроса: `fbe00e32-fdde-4465-b3e4-41bbd021a130`
...
## <a name="teams-usage-3p-apps"></a>Teams Приложения использования 3P

Отчет TeamsUsage3PApps за шесть месяцев

Идентификатор запроса: `42d287be-cc76-4109-a066-f3140ad97fe2`
...
## <a name="teams-usage-workload"></a>рабочая нагрузка Teams использования

Отчет Теамсусажеворклоад за шесть месяцев

Идентификатор запроса: `817fe875-acb0-4c45-9201-b7a35a60235a`
...
## <a name="teams-usage-meetings-and-calls"></a>Teams собраний и вызовов по использованию

Отчет Теамсусажемитингсандкаллс за шесть месяцев

Идентификатор запроса: `b7bd73a8-47e8-4c57-b915-445708cfd7bf`
...
## <a name="competency-summary-history"></a>Сводный журнал компетенции

Отчет Компетенцисуммарихистори за шесть месяцев

Идентификатор запроса: `fddab2aa-523d-47f6-90fe-588557306db4`
...
## <a name="training-completion"></a>Завершение обучения

Отчет о завершении обучения в течение шести месяцев

Идентификатор запроса: `20f5da57-3c2a-481b-b6a0-ec34d6db14e2`
...
Отчет Microsoft Learn за последние шесть месяцев

Идентификатор запроса: `0e06c7c3-75ab-4cd5-8178-8cf1a2de49cc`
...
- [Пример приложения для доступа к данным аналитики Partner Insights](insights-programmatic-sample-application.md)