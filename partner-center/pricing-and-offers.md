...
|Резервирование|Виртуальные машины с предварительной оплатой|Отсутствует|Сравнение прайс списков вручную из месяца в месяц|
...
|-------------------|-----------------------|----------------------------|-----------------------------|
|для образовательных учреждений|Клиент|Нет, клиентская квалификация будет выполнена корпорацией Майкрософт |Только на основе лицензий|
|Некоммерческая деятельность|Клиент|Нет, клиент находится за пределами центра партнеров|Только на основе лицензий|
