...
Чтобы просмотреть последние программы и предложения поставщика облачных решений (CSP), на панели мониторинга партнерского портала перейдите к статье **продажи > цен и предложений**. Там вы найдете отдельные прейскуранты для различных типов доступных продуктов. На странице **Цены и предложения** доступны следующие прейскуранты:

- **Службы на основе лицензий** включают сведения о ценах на Office 365, Enterprise Mobility, Security E3 и Dynamics 365. В разделе цены на основе лицензий содержатся цены на текущие и предварительные версии, а также матрицу списка предложений. Прайс-лист содержит прейскурантную цену и оценочные розничные цены (ERP) для предложений во всех поддерживаемых валютах. Матрица списка предложений включает сведения о доступности рынка и другие важные сведения о предложениях. Эти файлы обновляются в первый день каждого месяца.
- **Службы на основе использования** содержат сведения о ценах на Microsoft Azure и Visual Studio. Кроме того, можно использовать [службы Azure в калькуляторе цен CSP](https://azure.microsoft.com/pricing/calculator/). Загрузка на основе использования включает в себя оба прайс-листа CSP для всех поддерживаемых валют и файлы ценообразования общих служб в ERP. Эти файлы обновляются в первый день каждого месяца.
...
3. Перейдите к своему клиенту из списка клиентов. Выберите подписку для только что приобретенного базового предложения. На странице Управление подпиской вы увидите доступные надстройки, которые можно применить к базовому предложению.
