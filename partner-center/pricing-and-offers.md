...
|На основе использования|ресурсов Azure|Недоступно|Журнал изменений, доступный на вкладке " **История изменений** " прейскуранта за предыдущий месяц|
...
|Azure для государственных организаций|Партнер|Будучи квалифицированным, партнер работает в клиенте CSP, относящемся к Azure для государственных организаций.|ресурсов Azure|
