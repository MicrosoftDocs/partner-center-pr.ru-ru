---
title: Подключение к клиентам
description: Узнайте, как подключиться к новым и существующим клиентам как к непрямому торговому посреднику
ms.topic: how-to
