...
- Миграция из Data Warehouse в Microsoft Azure
    - Запись контроля доступа хранилища SQL: уровень обслуживания 1 = базы данных и уровень обслуживания 2 = хранилище данных SQL
- Kubernetes в Microsoft Azure
    - Запись контроля доступа Azure Kubernetes Service (AKS): воздействие на службы = AKS, AKS-Engine
- Виртуальный рабочий стол Microsoft Windows
    - Запись контроля доступа виртуальных рабочих столов Windows:% влияния на службы = собственный ВВД
- Модернизации веб-приложений для Microsoft Azure
...
- Аналитика на Microsoft Azure
    - Запись контроля доступа Azure синапсе Analytics: группа служб 3 = хранилище данных SQL
...
- Миграция из Windows Server и SQL Server в Microsoft Azure
    - Запись контроля доступа Windows: 
    ...
    - Запись контроля доступа базы данных SQL (БД): группа служб 3 = SQLDB
    - Запись контроля доступа SQL Управляемый экземпляр (MI): группа служб 3 = SQL DB MI
    - Запись контроля доступа виртуальной машины SQL: группа служб 3 = SQL в IaaS, SQL на виртуальной машине IaaS
- Миграция баз данных Linux и Open-Source в Microsoft Azure
    - Запись контроля доступа Виртуальные машины Linux (ВМ):
        - Вариант 1.
            - Тип корректировки записей контроля доступа = N/A, уровень обслуживания 2 = виртуальные машины, расчетная ОС = Linux, атрибут ОС вычислений = не Windows, неизвестно, Windows
            - Уровень обслуживания 4 = все, кроме облачных служб Microsoft Series, виртуальных машин Microsoft Series, виртуальных машин MS Series, виртуальных машин серии MSv2, виртуальных машин MSv2 Series, приложений для выделенного узла серии, MSv2, выделенного узла серии.
    ...
    - Запись контроля доступа SQL для базы данных Azure для Постгре: уровень обслуживания 1 = базы данных и уровень обслуживания 2 = PostgreSQL
