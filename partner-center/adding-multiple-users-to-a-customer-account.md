...
2.  Выберите в меню **Центра партнеров** выберите **пользователей**, а затем выберите клиента из списка.
...
6.  Выберите **Проверить**.
    ...
    **Примечание**большинство ошибок при создании учетной записи вызваны проблемами с файлом данных, включая отсутствие информации, деформированные или повторяющиеся электронные адреса или слишком много записей в файле.
