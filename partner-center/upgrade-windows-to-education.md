...
Начиная с 1 ноября 2020 г. поставщики облачных служб (CSP), которые приобрели подписки Microsoft 365 a3 или A5 или Windows 10 Корпоративная a3 или A5, могут помочь им в обновлении с Windows 10 Домашняя до Windows 10 для образовательных учреждений, которое предназначено как для занятий, так и для удаленного обучения.

С 1 ноября 2020 г. Windows 10 Домашняя будет подходящими операционными системами для образовательных учреждений, лицензированных с помощью соглашения Microsoft Cloud (с помощью программы CSP). Это право, которое прежде было доступно только через программы корпоративного лицензирования для образовательных учреждений, реализовано через портал администрирования Microsoft 365. 
