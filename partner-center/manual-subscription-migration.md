...
1.  В меню **Центра партнеров** выберите **пользователей**, выберите клиента, которого вы хотите перейти и выберите **Добавить подписки**.
...
1.  В меню **Центра партнеров** выберите **пользователей**, выберите клиента, которого вы хотите перейти и выбрать **пользователи и лицензии**. Откроется страница "Пользователи и лицензии" клиента.
...
1.  В меню **Центра партнеров** выберите **пользователей**, выберите клиента, которого вы хотите перейти и выберите подписку, которую требуется отменить.
