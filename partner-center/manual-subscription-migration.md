...
<a href="" id="purchasenewsubsc"></a>Торговому посреднику требуется переместить клиента с существующей подпиской на Dynamics AX Enterprise в Dynamics 365 for Operations. Прежде всего, необходимо приобрести Dynamics 365 for Operations.
