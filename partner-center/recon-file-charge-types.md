...
| Отмена пропорционального распределения экземпляра | Распределенные платежи отменяются, когда у клиента с месячной подпиской есть приостановленная подписка, а связанные с ней рабочие места были изменены в тот же месяц. |
...
| Convert | Используется при обновлении лицензии, но количество рабочих мест остается неизменным. |
