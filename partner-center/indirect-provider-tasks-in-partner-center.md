...
В качестве непрямого поставщика вы использовать центр партнеров, чтобы:
...
После выполнения этих действий, вы можете управлять своими связями торгового посредника на странице **торговых посредников** в меню **Центра партнеров** .
...
3. Выберите команду **Открыть в сообщении электронной почты**, чтобы открыть это сообщение в приложении электронной почты по умолчанию, или выберите **Копировать в буфер обмена**, чтобы скопировать и вставить его в сообщение электронной почты. По завершении нажмите кнопку **Готово**.
    > [!IMPORTANT]  
    >  Вы можете редактировать текст в сообщении электронной почты, но обязательно включите в него ссылку, так как оно будет персонализировано для вашей учетной записи центра партнеров.
...
Существующих подписок Если вы решите для работы с непрямым торговым посредником, можно обновить сведения о подписке для включения непрямого торгового посредника.

- На странице сведений подписки в поле **Торговый посредник (идентификатор MPN)** добавьте торгового посредника, который вы хотите работать с. Это гарантирует, что торговый посредник будет получать соответствующие поощрений.
...
В настоящее время косвенных поставщиков можно использовать информационную панель центра партнеров для размещения заказа и при необходимости выберите косвенный Торговый посредник как PartnerOnRecord. Если они не выбрать косвенный Торговый посредник, мы помечено как транзакции уровня 1 и которые мотивируют совершить покупку косвенный поставщик таким образом. Если они выбрать один, мы рассматриваем порядок как 2-го уровня транзакции и мы которые мотивируют совершить покупку косвенного поставщика и непрямого торгового посредника соответствующим образом:

 

Также существует взаимодействие где косвенный поставщик также обновить PartnerOnRecord существующих подписок:

 

Вы знаете, если имеется существующий документации на инструкции для косвенных поставщиков следует управлять PartnerOnRecord установки Пожалуйста?
Причина, по которой задать это связано с присутствует довольно значительные набор операций 2-го уровня, которые не были настроены правильно с непрямыми поставщиками, приведет к неверно выплаты поощрений. Как пройдет время, партнеры реализовать это и работы, чтобы Майкрософт, чтобы получить backpay на поощрений. Если мы не покрытия документации в этой области, я хочу получить помощь в упомянутый в один.
...
1.  Выберите **клиентов** меню **Центра партнеров** . 
