...
Являясь непрямым поставщиком, вы можете использовать информационную панель Центра партнеров для выполнения описанных ниже действий.
...
## <a name="indirect-provider-tasks-in-the-partner-dashboard"></a>Задачи непрямого поставщика в информационной панели Центра партнеров
...
1.  Изучите профиль вашей компании в [списке официальных косвенных поставщиков Майкрософт](https://partnercenter.microsoft.com/partner/find-a-provider). 
    ...
    -   Чтобы изменить профиль косвенного поставщика вашей компании, отправьте запрос в службу поддержки информационной панели Центра партнеров и укажите название компании, логотип и целевой URL-адрес для каждого расположения. Мы обновим ваш профиль в течение двух–трех недель.<br>

2.  Обмен информацией с косвенными торговыми посредниками

    - Прежде чем вы сможете взаимодействовать и проводить операции с торговыми посредниками, необходимо установить с ними партнерство в информационной панели Центра партнеров. <br>
...
> [!IMPORTANT]   
> Перед началом работы с торговыми посредниками в Центре партнеров они должны быть зарегистрированы в качестве непрямых торговых посредников в программе CSP и иметь учетные записи информационной панели Центра партнеров. Укажите своим торговым посредникам на раздел [Партнерство с непрямыми поставщиками в CSP](https://msdn.microsoft.com/partner-center/indirect-reseller-tasks-in-partner-center.md) для получения сведений о регистрации в CSP. 

## <a name="connect-with-indirect-resellers"></a>Обмен информацией с непрямыми торговыми посредниками

Для взаимодействия и проведения операций с непрямыми торговыми посредниками в информационной панели Центра партнеров необходимо установить с ними партнерство. Партнерство с непрямым торговым посредником позволяет как вам, так и торговому посреднику обслуживать общих клиентов.
...
3. Выберите команду **Открыть в сообщении электронной почты**, чтобы открыть это сообщение в приложении электронной почты по умолчанию, или выберите **Копировать в буфер обмена**, чтобы скопировать и вставить его в сообщение электронной почты. По завершении нажмите кнопку **Готово**.
    > [!IMPORTANT]  
    >  Можно редактировать текст в сообщении электронной почты, но обязательно включите в него ссылку, так как оно будет персонализировано для вашей учетной записи информационной панели центра партнеров.
...
При получении новых клиентов необходимо создать для них учетные записи в информационной панели Центра партнеров. При добавлении новой учетной записи клиента можно назначить определенного торгового посредника для управления учетной записью и администрирования подписок и служб клиентов от их имени. 
